...
//    m_properties.put(IRwtEnvironment.PROP_BUTTON_HEIGHT, 23);
//    m_properties.put(IRwtEnvironment.PROP_ACTIVATION_BUTTON_HEIGHT, rowHeight);
//    m_properties.put(IRwtEnvironment.PROP_ACTIVATION_BUTTON_WIDTH, rowHeight);
//    m_properties.put(IRwtEnvironment.PROP_ACTIVATION_BUTTON_WIDH_MENU_WIDTH, 34);
//    m_properties.put(IRwtEnvironment.PROP_FIELD_LABEL_WIDTH, 130);
//    m_properties.put(IRwtEnvironment.PROP_GROUP_BOX_ROW_HEIGHT, rowHeight);
//    m_properties.put(IRwtEnvironment.PROP_GROUP_BOX_COLUMN_WIDTH, 360);
//    m_properties.put(IRwtEnvironment.PROP_GROUP_BOX_HORIZONTAL_SPACING, 4);
//    m_properties.put(IRwtEnvironment.PROP_GROUP_BOX_VERTICAL_SPACING, 4);
//    m_properties.put(IRwtEnvironment.PROP_DIALOG_MIN_HEIGHT, 170);
//    m_properties.put(IRwtEnvironment.PROP_DIALOG_MIN_WIDTH, 360);
//    m_properties.put(IRwtEnvironment.PROP_FORM_FIELD_HORIZONTAL_SPACING, 4);
//    m_properties.put(IRwtEnvironment.PROP_DISABLED_FOREGROUND_COLOR, "9e9e9e");
//  }
//
