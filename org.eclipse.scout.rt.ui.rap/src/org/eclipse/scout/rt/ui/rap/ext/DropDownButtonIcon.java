...
//import org.eclipse.scout.rt.ui.rap.basic.IconGroup;
//import org.eclipse.scout.rt.ui.rap.basic.IconGroup.IconState;
...
// */
//public class DropDownButtonIcon extends Resource {
//
...
//
//  public DropDownButtonIcon(IRwtEnvironment env, Device device) {
//    super(device);
//    m_env = env;
...
////    c.prepareImage(getIconForState(), width, height, observer)
////    paintArrow(c, g, x, y);
////  }
//
//  private Image getIconForState() {
