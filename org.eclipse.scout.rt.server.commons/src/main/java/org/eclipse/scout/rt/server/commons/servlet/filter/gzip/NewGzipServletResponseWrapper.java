...
public class NewGzipServletResponseWrapper extends HttpServletResponseWrapper {

  private static final Logger LOG = LoggerFactory.getLogger(NewGzipServletResponseWrapper.class);
  ...
  public NewGzipServletResponseWrapper(HttpServletResponse response, HttpServletRequest request, int compressThreshold, Set<String> contentTypes, boolean enableEmptyContentTypeLogging) {
    super(response);
    m_request = request;
