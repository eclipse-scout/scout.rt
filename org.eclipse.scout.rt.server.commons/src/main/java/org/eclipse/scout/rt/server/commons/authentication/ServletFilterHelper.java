...
public class ServletFilterHelper {
   ...
   *
   * @return true if a redirect was sent to the browser
   */
  public boolean redirectIncompleteBasePath(HttpServletRequest request, HttpServletResponse response) throws IOException {
