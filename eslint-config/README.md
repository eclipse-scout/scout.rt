...
ESLint [shareable config](https://eslint.org/docs/developer-guide/shareable-configs.html) for the [Scout](https://www.npmjs.com/package/@eclipse-scout/core) JavaScript style.
