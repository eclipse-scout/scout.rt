...
public class HttpServerSessionRunContextProducerTest {
  ...
  public void testGetOrCreateScoutSessionWithRandomId() {
    ...
    ServerSessionRunContext context = producer.produce(req, resp, null, null);
  ...
  protected HttpServletRequest createRequestMock(String serverSessionId, String clientSessionId) {
    ...
    when(httpSession.getAttribute(eq(HttpServerSessionRunContextProducer.SCOUT_SESSION_ID_KEY))).thenReturn(serverSessionId);
