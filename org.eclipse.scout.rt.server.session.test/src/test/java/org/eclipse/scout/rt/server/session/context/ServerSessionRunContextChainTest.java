...
public class ServerSessionRunContextChainTest {

  /**
   * Tests the correct order of interceptors in {@link ServerSessionRunContext}.
   */
  @Test
  public void testCallableChain() {
    CallableChain<Object> chain = new ServerSessionRunContext() {
      @Override
