 ...
 */
package org.eclipse.scout.rt.testing.server.session.runner.statement;
 ...
 * @since 5.1
 */
public class ServerSessionRunContextStatement extends Statement {

  private final Statement m_next;
  private final RunWithServerSession m_serverSessionAnnotation;

  public ServerSessionRunContextStatement(final Statement next, final RunWithServerSession serverSessionAnnotation) {
