...
public class HandlerArtifactProcessor {
  ...
  protected String createAndPersistHandlerXmlFile(final JClass portTypeProxy, final PortTypeProxyDescriptor decoration, final List<String> handlers, final Filer filer) throws Exception {
    ...
    out.printf("This file is updated once any WSDL artifact or %s changes. If providing a handler chain binding file yourself, this file will not be generated.", decoration.getDeclaringType().getSimpleName()).println();
    out.println();
