...
public class HandlerArtifactProcessor {
  ...
  protected String createAndPersistHandlerXmlFile(final JClass portTypeProxy, final PortTypeProxyDescriptor descriptor, final List<String> handlers, final Filer filer) throws Exception {
    ...
    out.println();
    out.printf("This file is auto-generated by APT triggered by Maven build, and is populated with handlers declared in '%s'. This file is referenced in @%s annotation in '%s'.<br/>", descriptor.getDeclaringType().getSimpleName(), HandlerChain.class.getSimpleName(), portTypeProxy.name()).println();
    ...
    out.printf("This file is updated once any WSDL artifact or %s changes. If providing a handler chain binding file yourself, this file will not be generated.", descriptor.getDeclaringType().getSimpleName()).println();
    out.println();
