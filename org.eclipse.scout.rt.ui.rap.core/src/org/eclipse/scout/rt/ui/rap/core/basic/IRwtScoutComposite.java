 ...
 *******************************************************************************/
package org.eclipse.scout.rt.ui.rap.core.basic;
...
public interface IRwtScoutComposite<T extends IPropertyObserver> {
  ...
  void createUiField(Composite parent, T model, IRwtCoreEnvironment environment);
  ...
  IRwtCoreEnvironment getUiEnvironment();
