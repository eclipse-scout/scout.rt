...
/**
 * Converts the given decimal number to base-62 (i.e. the same value, but represented
 * by [a-zA-Z0-9] instead of only [0-9].
 */
...
scout.getTimestamp = function() {
  ...
  return date.getFullYear() +
    ...
    padZeroLeft(date.getDate(), 2) +
    padZeroLeft(date.getHours(), 2) +
