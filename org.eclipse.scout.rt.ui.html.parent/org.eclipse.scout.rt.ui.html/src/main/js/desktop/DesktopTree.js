...
scout.DesktopTree.prototype._render = function($parent) {
  ...
  this._$desktopTreeScroll = this.$container.appendDIV('tree-scroll');
...
scout.DesktopTree.prototype._updateItemPath = function() {
...
scout.DesktopTree.prototype._setMenus = function () {
  // XXX: braucht es doch nicht mehr!
};