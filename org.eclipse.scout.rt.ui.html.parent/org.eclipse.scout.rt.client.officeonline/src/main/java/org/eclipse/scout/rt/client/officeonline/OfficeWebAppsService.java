...
import org.eclipse.scout.rt.client.officeonline.wopi.WopiUtility;
...
public class OfficeWebAppsService extends AbstractService implements IOfficeWebAppsService {
  ...
  public void initializeService(ServiceRegistration registration) {
    ...
    m_discoveryUrl = Activator.getBundleContext().getProperty(CONFIG_INI_DISCOVERY_URL);
    if (m_discoveryUrl == null) {
  ...
  protected void ensureWopiConfigLoaded() throws IOException {
    ...
    document.parseStream(new URL(m_discoveryUrl).openStream());
