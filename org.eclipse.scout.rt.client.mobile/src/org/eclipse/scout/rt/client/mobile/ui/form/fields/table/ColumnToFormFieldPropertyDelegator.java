 ...
 * @since 3.9.0
 */
public class ColumnToFormFieldPropertyDelegator<SENDER extends IColumn, RECEIVER extends IFormField> extends PropertyDelegator<SENDER, RECEIVER> {

  public ColumnToFormFieldPropertyDelegator(SENDER sender, RECEIVER receiver) {
