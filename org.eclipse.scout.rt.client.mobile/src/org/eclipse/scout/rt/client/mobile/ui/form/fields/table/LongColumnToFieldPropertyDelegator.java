 ...
 * @since 3.9.0
 */
public class LongColumnToFieldPropertyDelegator extends ColumnToFormFieldPropertyDelegator<ILongColumn, ILongField> {

  public LongColumnToFieldPropertyDelegator(ILongColumn sender, ILongField receiver) {
