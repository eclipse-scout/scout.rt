...
/**
 * Represents an unwrapped {@link ColumnClassId} or a dynamically created {@link UUID}.
 */
...
public final class TableColumnId extends AbstractStringId {
  ...
  public static TableColumnId of(ColumnClassId columnClassId) {
    if (columnClassId == null) {
      return null;
    }
    return new TableColumnId(columnClassId.unwrap());
  }
}
