...
public class CodeTypeDo extends DoEntity {
  ...
  public DoValue<Boolean> isHierarchical() {
    return doValue("isHierarchical");
  }
  ...
  @Generated("DoConvenienceMethodsGenerator")
  public CodeTypeDo withIsHierarchical(Boolean isHierarchical) {
    isHierarchical().set(isHierarchical);
    return this;
  }

  @Generated("DoConvenienceMethodsGenerator")
  public Boolean getIsHierarchical() {
    return isHierarchical().get();
  }

  @Generated("DoConvenienceMethodsGenerator")
  public boolean isIsHierarchical() {
    return nvl(getIsHierarchical());
  }
