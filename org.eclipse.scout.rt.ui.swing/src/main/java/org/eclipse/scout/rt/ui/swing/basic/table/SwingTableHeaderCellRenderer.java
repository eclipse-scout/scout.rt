...
public class SwingTableHeaderCellRenderer implements TableCellRenderer {
  ...
  public SwingTableHeaderCellRenderer(TableCellRenderer internalRenderer, SwingScoutTable t) {
    ...
    m_swingScoutTable = t;
    m_filterActiveIcon = SwingIconLocator.INSTANCE.getIcon(SwingIcons.TableColumnFilterActive);
    m_customColumnIcon = SwingIconLocator.INSTANCE.getIcon(SwingIcons.TableCustomColumn);
  }
