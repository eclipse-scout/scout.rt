...
public class SwingScoutFormFieldGridData extends LogicalGridData {
  private IFormField m_scoutField;

  public SwingScoutFormFieldGridData(IFormField scoutField) {
  ...
  public void validate() {
    ...
    // setup constraints
    SwingScoutFormFieldGridData gc = this;
    gc.gridx = data.x;
    gc.gridy = data.y;
    gc.gridw = data.w;
    gc.gridh = data.h;
