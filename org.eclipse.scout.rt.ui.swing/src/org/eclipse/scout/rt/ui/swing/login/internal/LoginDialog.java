...
public class LoginDialog extends JDialogEx {
  ...
  protected void createContents() {
    ...
    userLabel.setText(ScoutTexts.get("Username"));
    ...
    passLabel.setText(ScoutTexts.get("Password"));
    ...
    if (InternalNetAuthenticator.NET_AUTHENTICATION_CACHE_ENABLED) {
       ...
       */
      m_saveCheckBox = new JCheckBox(ScoutTexts.get("SavePassword"), false);
