...
public class DateChooser {
  ...
  /**
   * fires whenever a date is picked, even if it is the selection was not changed
   */
  ...
  private void updateStates() {
    ...
    if (m_displayMode == DISPLAY_MODE_DAY) {
      ...
      m_monthLabel.setText(new SimpleDateFormat("MMM yyyy", Locale.getDefault()).format(vd) + " - " + UIManager.getString("Calendar.weekText") + " " + weekNo);
    }
    else if (m_displayMode == DISPLAY_MODE_WORKWEEK) {
