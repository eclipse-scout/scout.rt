...
/**
 * In Scout 3.9 SwingScoutPlannerField will be typed and this class will be removed.
 */
public class SwingScoutTypedPlannerField extends SwingScoutFieldComposite<ITypedPlannerField<?, ?, ?, ?>> implements ISwingScoutTypedPlannerField {
  private ISwingScoutTable m_resourceTableComposite;
  private SwingScoutActivityMapTyped m_activityMapComposite;
  ...
  public SwingScoutTypedPlannerField() {
  }
  ...
  protected void initializeSwing() {
    ...
    m_activityMapComposite = new SwingScoutActivityMapTyped(m_resourceTableComposite.getSwingTable());
  ...
  @Override
  public SwingScoutActivityMapTyped getActivityMapComposite() {
