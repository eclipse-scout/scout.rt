...
/**
 * In Scout 3.9 SwingActivityComponent will be typed and this class will be removed.
 */
public class SwingActivityComponentTyped extends DefaultActivityComponent {
  private static final long serialVersionUID = 1L;

  private ActivityCellTyped<?, ?> m_cell;

  public SwingActivityComponentTyped(ActivityCellTyped<?, ?> cell, int rowIndex) {
    super(rowIndex);
    m_cell = cell;
  ...
  public ActivityCellTyped<?, ?> getScoutActivityCell() {
    return m_cell;
  }
