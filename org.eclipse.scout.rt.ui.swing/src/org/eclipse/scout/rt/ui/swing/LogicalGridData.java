...
public class LogicalGridData {
  ...
  public String toString() {
    return getClass().getSimpleName() + "[" + gridx + ", " + gridy + ", " + gridw + ", " + gridh + ", " + weightx + ", " + weighty + ", useUiWidth=" + useUiWidth + ", useUiHeight=" + useUiHeight + ", widthHint=" + widthHint + ", heightHint=" + heightHint + ", topInsets=" + topInset + ", fillHorizontal=" + fillHorizontal + ", fillVertical=" + fillVertical + "]";
  }
