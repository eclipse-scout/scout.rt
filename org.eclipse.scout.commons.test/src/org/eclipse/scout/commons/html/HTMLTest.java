...
public class HTMLTest {
  ...
  public void testEquality() {
    assertEquals(HtmlHelper.escapeAndNewLineToBr("one & two\nthree & four"), HTML.fragment("one & two\nthree & four").toHtml());
    assertEquals(HtmlHelper.escape("one & two\nthree & four"), HTML.fragment("one & two\nthree & four").withNewLineToBr(false).toHtml());

    assertEquals(HTML.raw(HtmlHelper.escapeAndNewLineToBr("one & two\nthree & four")).toHtml(), HTML.fragment("one & two\nthree & four").toHtml());
    assertEquals(HTML.raw(HtmlHelper.escape("one & two\nthree & four")).toHtml(), HTML.fragment("one & two\nthree & four").withNewLineToBr(false).toHtml());
  }
}
