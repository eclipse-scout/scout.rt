...
public class ClientSessionTest {
  ...
  public void testStop() throws Exception {
    ...
    session = BEANS.get(ClientSessionProvider.class).provide(ClientRunContexts.empty().withUserAgent(UserAgent.createDefault()));
  ...
  public void testStopWithClosedMessageBox() throws Exception {
    ...
    ModelJobs.schedule(new IRunnable() {
      @Override
      public void run() throws Exception {
        session.getDesktop().getUIFacade().fireDesktopClosingFromUI(true);
      }
    }, ModelJobs
        .newInput(ClientRunContexts
            .empty()
