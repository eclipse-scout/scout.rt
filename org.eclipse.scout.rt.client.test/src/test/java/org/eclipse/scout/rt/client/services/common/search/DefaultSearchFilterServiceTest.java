...
public class DefaultSearchFilterServiceTest {
  ...
  public void testUncheckedBooleanField() {
    ...
    Assert.assertEquals(LABEL + " " + ScoutTexts.get("LogicLike") + " " + stringField.getDisplayText() + "\n" +
        LABEL + "\n" + // <--
        LABEL + " " + ScoutTexts.get("LogicLike") + " " + stringField2.getDisplayText(),
