...
public class MultipleSessionTest {
  ...
  public void testMutalExclusion() throws ProcessingException, InterruptedException {
    ...
    }, ModelJobs.newInput(ClientRunContexts.empty().withSession(m_clientSession1, true)).name("job-1-S1").logOnError(false));
    ...
    }, ModelJobs.newInput(ClientRunContexts.empty().withSession(m_clientSession1, true)).name("job-2-S1").logOnError(false));
    ...
    }, ModelJobs.newInput(ClientRunContexts.empty().withSession(m_clientSession2, true)).name("job-1-S2").logOnError(false));
    ...
    }, ModelJobs.newInput(ClientRunContexts.empty().withSession(m_clientSession2, true)).name("job-2-S2").logOnError(false));
