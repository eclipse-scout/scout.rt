...
public class ClientJobCallableChainTest {
  ...
  public void testCallableChain() throws Exception {
    Callable<Void> actualCallable = new _ClientJobManager().interceptCallable(m_targetCallable, ClientJobInput.defaults());
  ...
  public void testCallableChainWithContributionsAfter() throws Exception {
    _ClientJobManager jobManager = new _ClientJobManager() {
      @Override
