...
public class GroupBoxLayout04Test extends AbstractGroupBoxLayoutTest {
  ...
  public void testVerticalLayout() throws Exception {
    ...
    // field01
    assertGridData(0, 0, 1, 1, groupBox.getFieldByClass(GroupBoxLayout04Test.MainBox.Field01.class).getGridData());

    // field02
    assertGridData(1, 0, 1, 1, groupBox.getFieldByClass(GroupBoxLayout04Test.MainBox.Field02.class).getGridData());

    // field03
    assertGridData(0, 1, 2, 1, groupBox.getFieldByClass(GroupBoxLayout04Test.MainBox.Field03.class).getGridData());

    // field04
    assertGridData(2, 0, 1, 1, groupBox.getFieldByClass(GroupBoxLayout04Test.MainBox.Field04.class).getGridData());
  ...
  public void testHorizontalLayout() throws Exception {
    ...
    // field04
    assertGridData(2, 1, 1, 1, groupBox.getFieldByClass(GroupBoxLayout04Test.MainBox.Field04.class).getGridData());
