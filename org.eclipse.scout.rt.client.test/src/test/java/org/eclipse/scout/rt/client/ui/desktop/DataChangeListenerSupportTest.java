...
public class DataChangeListenerSupportTest {
  ...
  public void testRegisterNullListener() {
    ...
    assertEquals(0, m_support.getListenersByDataType().get(null).list().size());
  ...
  public void testRegisterListener() {
    ...
    assertEquals(1, m_support.getListenersByDataType().size());
    assertEquals(1, m_support.getListenersByDataType().get(null).list().size());
  ...
  public void testRegisterTypedListener() {
    ...
    assertEquals(1, m_support.getListenersByDataType().get(String.class).list().size());
    assertEquals(1, m_support.getListenersByDataType().get(Long.class).list().size());
