...
public class ClientJobContextTest {
  ...
  public void testGetAndSet() {
    ...
    assertEquals(value2, context.get(key1));

    context.set(key1, null);
    assertEquals(null, context.get(key1));

    context.clear();
    assertEquals(null, context.get(key2));
  }
  ...
  public void testClone() {
    ...
    assertEquals(context.get(key1), anotherContext.get(key1));
    assertEquals(context.get(key2), anotherContext.get(key2));

    context.clear();

    assertEquals(value1, anotherContext.get(key1));
    assertEquals(value2, anotherContext.get(key2));
  }
}
