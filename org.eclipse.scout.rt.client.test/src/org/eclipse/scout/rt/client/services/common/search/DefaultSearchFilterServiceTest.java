  ...
  public class MyListBox extends AbstractListBox<Long> {
    ...
    protected LookupRow[] execLoadTableData() throws ProcessingException {
      LookupRow[] data = new LookupRow[]{
          new LookupRow(1L, "Element 1"),
          new LookupRow(2L, "Element 2"),
          new LookupRow(3L, "Element 3"),
          new LookupRow(4L, "Element 4"),
          new LookupRow(5L, "Element 5")
      };
      return data;
    }
  }
