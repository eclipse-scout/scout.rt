...
public class ReplaceTableTest {
  ...
  public void testBaseForm() throws Exception {
    ...
    // menus
    assertEquals(7, form.getTableField().getTable().getMenus().size());

    assertSame(form.getTableField().getTable().getFirstMenu(), form.getTableField().getTable().getMenus().get(5));
    assertSame(form.getTableField().getTable().getSecondMenu(), form.getTableField().getTable().getMenus().get(6));
  }
  ...
  public void testExtendedForm() throws Exception {
    ...
    assertSame(form.getTableExField().getTableEx().getFirstExMenu(), form.getTableField().getTable().getMenus().get(5));
    assertSame(form.getTableExField().getTableEx().getThirdMenu(), form.getTableField().getTable().getMenus().get(6));
    assertSame(form.getTableExField().getTableEx().getSecondMenu(), form.getTableField().getTable().getMenus().get(7));
  ...
  public void testExtendedFormUsingTemplates() throws Exception {
    ...
    assertEquals(8, form.getTableField1().getTable().getMenus().size());
    assertEquals(8, form.getFirstGroupBoxEx().getTableFieldEx1().getTable().getMenus().size());

    assertSame(form.getTableField1().getTable().getFirstMenu(), form.getTableField1().getTable().getMenus().get(5));
    assertSame(form.getFirstGroupBoxEx().getTableFieldEx1().getTableEx1().getThirdMenu1(), form.getTableField1().getTable().getMenus().get(6));
    assertSame(form.getFirstGroupBoxEx().getTableFieldEx1().getTableEx1().getSecondMenuEx1(), form.getTableField1().getTable().getMenus().get(7));
    ...
    assertEquals(8, form.getSecondGroupBox().getInnerTableField().getTable().getMenus().size());
    assertEquals(8, form.getSecondGroupBoxEx().getInnerTableFieldEx1().getTable().getMenus().size());

    assertSame(form.getSecondGroupBoxEx().getInnerTableFieldEx1().getInnerTableEx1().getSecondMenuEx2(), form.getSecondGroupBox().getInnerTableField().getTable().getMenus().get(5));
    assertSame(form.getSecondGroupBox().getInnerTableField().getTable().getFirstMenu(), form.getSecondGroupBox().getInnerTableField().getTable().getMenus().get(6));
    assertSame(form.getSecondGroupBoxEx().getInnerTableFieldEx1().getInnerTableEx1().getThirdMenu2(), form.getSecondGroupBox().getInnerTableField().getTable().getMenus().get(7));
