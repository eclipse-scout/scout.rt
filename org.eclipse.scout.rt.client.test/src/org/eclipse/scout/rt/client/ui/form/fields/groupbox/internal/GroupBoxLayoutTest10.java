 ...
 */
public class GroupBoxLayoutTest10 extends AbstractGroupBoxLayoutTest {
  ...
  public void testVerticalLayout() throws Exception {
    ...
    // field01
    assertGridData(0, 0, 1, 1, groupBox.getFieldByClass(GroupBoxLayoutTest10.LayoutGroupBox.Field01.class).getGridData());

    // field02
    assertGridData(1, 0, 1, 1, groupBox.getFieldByClass(GroupBoxLayoutTest10.LayoutGroupBox.Field02.class).getGridData());

    // field03
    assertGridData(0, 1, 2, 1, groupBox.getFieldByClass(GroupBoxLayoutTest10.LayoutGroupBox.Field03.class).getGridData());

    // field04
    assertGridData(0, 2, 1, 1, groupBox.getFieldByClass(GroupBoxLayoutTest10.LayoutGroupBox.Field04.class).getGridData());

    // field05
    assertGridData(2, 0, 1, 1, groupBox.getFieldByClass(GroupBoxLayoutTest10.LayoutGroupBox.Field05.class).getGridData());

    // field06
    assertGridData(1, 2, 2, 1, groupBox.getFieldByClass(GroupBoxLayoutTest10.LayoutGroupBox.Field06.class).getGridData());
  }
  ...
  public void testHorizontalLayout() throws Exception {
    ...
    // field04
    assertGridData(2, 1, 1, 1, groupBox.getFieldByClass(GroupBoxLayoutTest10.LayoutGroupBox.Field04.class).getGridData());

    // field05
    assertGridData(0, 2, 1, 1, groupBox.getFieldByClass(GroupBoxLayoutTest10.LayoutGroupBox.Field05.class).getGridData());
