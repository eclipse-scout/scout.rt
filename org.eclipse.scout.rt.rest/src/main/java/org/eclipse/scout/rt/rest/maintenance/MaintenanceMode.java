 ...
 * <p>Annotation may be used on types and their methods, if it is provided on both of them the method's annotation is the relevant one (allowing to disable a resource type in general for maintenance mode and enable a specific method on the type).</p>
 */
