...
public class DefaultServerSessionFactory implements IServerSessionFactory {
  ...
  public IServerSession create() {
    String qnSession = ConfigIniUtility.getProperty(DefaultServerSessionFactory.PROP_QN_SESSION);
    String snBundle = ConfigIniUtility.getProperty(DefaultServerSessionFactory.PROP_SN_BUNDLE);
