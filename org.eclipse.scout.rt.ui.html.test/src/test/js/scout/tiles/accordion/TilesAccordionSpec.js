 ...
 ******************************************************************************/
describe("TilesAccordion", function() {
  var session;
  ...
  function createAccordion(numGroups, model) {
    ...
    return scout.create('TilesAccordion', model);
  }
  ...
  describe('init', function() {
    it('copies properties to tile grids', function() {
      ...
      expect(accordion.groups[0].body.layoutConfig).toEqual(scout.TilesLayoutConfig.ensure({
        columnWidth: 100,
        rowHeight: 100
      }));
