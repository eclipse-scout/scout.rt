...
@Order(5140)
public class T5140_ResolveTopLevelEnumReferencesAndCreateImports extends AbstractTask {
  private static final Logger LOG = LoggerFactory.getLogger(T5140_ResolveTopLevelEnumReferencesAndCreateImports.class);
