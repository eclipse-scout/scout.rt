...
/**
 * Parses a JSON (<a href="http://www.ietf.org/rfc/rfc4627.txt">RFC 4627</a>) encoded string into the corresponding
 ...
 * input string was valid JSON. All of the following syntax errors will be ignored:
 * <ul>
...
public class JSONTokener {
  ...
  /**
   * Returns the next available character, or the null character '\0' if all input has been exhausted. The return value
  ...
  /**
   * Returns the next character that is not whitespace and does not belong to a comment. If the input is exhausted
   ...
   * <p>
   * The returned string shares its backing character array with this tokener's input string. If a reference to the
   * returned string may be held indefinitely, you should use {@code new String(result)} to copy it first to avoid
   * memory leaks.
   *
   * @throws JSONException
  ...
  /**
   * Advances past all input up to and including the next occurrence of {@code thru}. If the remaining input doesn't
  ...
  /**
   * Advances past all input up to but not including the next occurrence of {@code to}. If the remaining input doesn't
