...
export default class DesktopHeader extends Widget {
    ...
    updateViewButtonBoxVisibility() {
        ...
        this.setViewButtonBoxVisible(this.desktop.viewButtons.length > 0 && !this.desktop.navigationVisible && this.desktop.displayStyle !== DisplayStyle.COMPACT);
    };
