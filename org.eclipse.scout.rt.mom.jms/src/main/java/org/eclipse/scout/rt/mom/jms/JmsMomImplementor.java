...
public class JmsMomImplementor implements IMomImplementor {
  ...
  public IJmsSessionProvider createSessionProvider(final IDestination<?> destination, boolean transacted) throws JMSException {
  ...
  public synchronized void destroy() {
    try {
      ...
      IFilter<IFuture<?>> momJobsFilter = Jobs.newFutureFilterBuilder().andMatchExecutionHint(m_momUid).toFilter();
