...
public class DownloadHttpResponseInterceptorTest {
  ...
  public void testContentDispositionResponseHeader() {
    String actual = new DownloadHttpResponseInterceptor("simple.pdf").getHeaderValue();
  ...
  public void testContentDispositionResponseHeaderNullFillsDefaultValue() {
    String actual = new DownloadHttpResponseInterceptor(null).getHeaderValue();
    Assert.assertEquals("attachment; filename=\""
        + "Download"
        + "\"; filename*=utf-8''"
        + "Download"
  ...
  public void testContentDispositionResponseHeaderEmptyFillsDefaultValue() {
    String actual = new DownloadHttpResponseInterceptor("").getHeaderValue();
    Assert.assertEquals("attachment; filename=\""
        + "Download"
        + "\"; filename*=utf-8''"
        + "Download"
  ...
  public void testContentDispositionResponseHeaderDoubleQuotes() {
    String actual = new DownloadHttpResponseInterceptor("x\"x").getHeaderValue();
    Assert.assertEquals("attachment; filename=\""
        + "xx"
        + "\"; filename*=utf-8''"
        + "x%22x"
  ...
  public void testContentDispositionResponseHeaderUrlEncodeTrimsWhitespace() {
    String actual = new DownloadHttpResponseInterceptor("   x   ").getHeaderValue();
    Assert.assertEquals("attachment; filename=\""
        + "   x   "
        + "\"; filename*=utf-8''"
        + "x"
  ...
  public void testContentDispositionResponseHeaderUmlauts() {
    String actual = new DownloadHttpResponseInterceptor("TestäüöÄÜÖ.pdf").getHeaderValue();
    Assert.assertEquals("attachment; filename=\""
        + "TestäüöÄÜÖ.pdf"
        + "\"; filename*=utf-8''"
  ...
  public void testContentDispositionResponseHeaderEuroSignIsRemovedInIso88591() {
    String actual = new DownloadHttpResponseInterceptor("Test 5€.pdf").getHeaderValue();
    Assert.assertEquals("attachment; filename=\""
        + "Test 5.pdf"
        + "\"; filename*=utf-8''"
  ...
  public void testContentDispositionResponseHeaderControlCharacters() throws UnsupportedEncodingException {
    ...
    String actual = new DownloadHttpResponseInterceptor(s).getHeaderValue();
