...
export default class Call {
  ...
  protected _setResultDone(...args) {
    this._setResult(...args);
  }

  protected _setResultFail(...args) {
    this._setResult(...args);
  }

  protected _onCallDone() {
    // Call successful -> RESOLVE
    this._resolve();
  }

  protected _onCallFail(...args) {
    // Aborted? -> REJECT
    if (this.aborted) {
