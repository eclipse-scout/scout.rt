 ...
 *
 * @param {string} rgba a color in rgb or rgba format
 * @param {boolean} forceRemoveAlpha true, if the alpha value should be removed, otherwise false.
 * @return {string|null} the color in hex format
 */
