 ...
 */
import {FileChooser, FileChooserController, FileChooserModel, Form, FormController, GroupBox, KeyStroke, MessageBox, MessageBoxController, MessageBoxModel, Status, Widget, WidgetModel} from '../index';
...
export default interface FormModel extends WidgetModel {
   ...
   */
  movable?: boolean;
  rootGroupBox?: GroupBox; // FIXME TS: | RefModel<GroupBoxModel>;
  /**
   * Default is false.
   */
  saveNeeded?: boolean;
