 ...
 */
import {
  aria, Device, Event, EventHandler, FieldStatus, FormField, HtmlComponent, HtmlEnvironment, InitModelOf, ObjectUuidProvider, PropertyChangeEvent, scout, SomeRequired, Status, strings, TabEventMap, TabItem, TabModel, tooltips, Widget
} from '../../../index';
...
export class Tab extends Widget implements TabModel {
  ...
  protected override _init(options: InitModelOf<this>) {
    ...
    ObjectUuidProvider.get().setDependentUuid('tab', this.tabItem, this);
