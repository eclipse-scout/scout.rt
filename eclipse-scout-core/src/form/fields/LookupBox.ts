...
export abstract class LookupBox<TLookup, TValue = TLookup[]> extends ValueField<TValue, TLookup | TValue> implements LookupBoxModel<TLookup, TValue> {
  ...
  declare self: LookupBox<TLookup, TValue>;
  ...
  protected override _ensureValue(value: TLookup | TValue): TValue {
    return this._ensureValueDefault(value as TLookup | TLookup[]) as TValue;
  }

  /* **********************************************************************
   * Default implementations of value handling methods (TValue = TLookup[])
   * ********************************************************************** */
  protected _ensureValueDefault(value: TLookup | TLookup[]): TLookup[] {
