...
import {
  ...
  ObjectIdProvider, Outline, PropertyChangeEvent, scout, SingleLayout, strings, styles, Tree, ViewButtonBox, Widget
} from '../../index';
...
ObjectIdProvider.uuidPathSkipWidgets.add(DesktopNavigation);
