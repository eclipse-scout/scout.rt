 ...
 */
import {arrays, ContextMenuPopup, Desktop, Device, DoubleClickSupport, dragAndDrop, DragAndDropHandler, EnumObject, Event, FilterResult, FilterSupport, graphics, HtmlComponent, KeyStroke, KeyStrokeContext, keyStrokeModifier, LazyNodeFilter, Menu, MenuBar, MenuDestinations, MenuItemsOrder, menus as menuUtil, objects, Popup, Range, scout, scrollbars, tooltips, TreeBreadcrumbFilter, TreeCollapseAllKeyStroke, TreeCollapseOrDrillUpKeyStroke, TreeExpandOrDrillDownKeyStroke, TreeLayout, TreeModel, TreeNavigationDownKeyStroke, TreeNavigationEndKeyStroke, TreeNavigationUpKeyStroke, TreeNode, TreeNodeModel, TreeSpaceKeyStroke, UpdateFilteredElementsOptions, Widget} from '../index';
import $ from 'jquery';
...
export default class Tree extends Widget implements TreeModel {
  ...
  protected _onDesktopPopupOpen(event: Event<Desktop> & { popup: Popup }) { // FIXME TS: add PopupOpenEvent as soon as Desktop has been migrated
