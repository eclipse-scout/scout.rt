 ...
 */
export function exactPrefSize(prefSize: Dimension, options: PrefSizeOptions): Dimension {
 ...
 */
export function prefSizeWithoutAnimation($elem: JQuery, options: PrefSizeOptions): Dimension {
...
export function setSize($comp: JQuery, width: number, height: number);
export function setSize($comp: JQuery, size: Dimension);
export function setSize($comp: JQuery, widthOrSize: Dimension | number, height?: number) {
...
export function margins($comp: JQuery): Insets {
  return insets($comp, {
    includeMargin: true,
...
export function setMargins($comp: JQuery, margins: Insets) {
  $comp.css({
...
export function paddings($comp: JQuery): Insets {
  return insets($comp, {
    includeMargin: false,
    includePadding: true,
    includeBorder: false
...
export function borders($comp: JQuery): Insets {
  return insets($comp, {
    includeMargin: false,
    includePadding: false,
    includeBorder: true
...
export function setLocation($comp: JQuery, x: number, y: number);
export function setLocation($comp: JQuery, location: Point);
/**
 * Sets the location (CSS properties left, top) of the component.
 */
export function setLocation($comp: JQuery, xOrPoint: number | Point, y?: number) {
...
export function _bounds($elem: JQuery, pos: JQuery.Coordinates, options?: BoundsOptions | boolean): Rectangle {
  let s = size($elem, options);
  return new Rectangle(pos.left, pos.top, s.width, s.height);
}

export function setBounds($comp: JQuery, x: number, y: number, width: number, height: number);
export function setBounds($comp: JQuery, bounds: Rectangle);
export function setBounds($comp: JQuery, xOrBounds: number | Rectangle, y?: number, width?: number, height?: number) {
