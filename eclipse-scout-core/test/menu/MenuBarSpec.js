...
describe('MenuBar', function() {
  ...
  describe('enabled', function() {
    it('updates enabledComputed properly if disabled menu is moved out of ellipsis', function() {
      var menu1 = helper.createMenu(createModel('move it'));
      var menu2 = helper.createMenu(createModel('my menu'));
    ...
    it('updates enabledComputed properly if disabled menu is moved into ellipsis', function() {
      var menu1 = helper.createMenu(createModel('move it'));
      menu1.setVisible(false);
      var menu2 = helper.createMenu(createModel('my menu'));
      menu2.setEnabled(false);
