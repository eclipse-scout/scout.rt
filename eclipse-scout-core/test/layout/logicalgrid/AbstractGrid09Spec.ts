...
describe('AbstractGrid09', () => {
  ...
  describe('group box layout 09', () => {
    it('test horizontal layout', function() {
      ...
      // field03
      GroupBoxSpecHelper.assertGridData(0, 2, 1, 1, this.fields[2].gridData);

      // field04
      GroupBoxSpecHelper.assertGridData(1, 2, 1, 2, this.fields[3].gridData);
    });
