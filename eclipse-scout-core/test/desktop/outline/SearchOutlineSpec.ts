...
describe('SearchOutline', () => {
  ...
  describe('setSearchStates', () => {
    ...
    it('triggers _addSearchState and _removeSearchState', () => {
      const outline = createSearchOutline();
      const searchPage0 = createSearchPage(outline, {text: 'SearchPage0'});
      const searchPage1 = createSearchPage(outline, {text: 'SearchPage1'});
      const searchPage2 = createSearchPage(outline, {text: 'SearchPage2'});
      ...
      spyOn(outline, '_addSearchState').and.callThrough();
      spyOn(outline, '_removeSearchState').and.callThrough();

      outline.setSearchStates(new Set([searchPage1.searchState, searchPage2.searchState]));

      expect(outline._addSearchState).toHaveBeenCalledOnceWith(searchPage2.searchState);
      expect(outline._removeSearchState).toHaveBeenCalledOnceWith(searchPage0.searchState);
    });
  });

  describe('_addSearchState', () => {

    it('installs listeners', () => {
      const outline = createSearchOutline();
      const searchPage = createSearchPage(outline, {text: 'SearchPage'});

      expect(searchPage.searchState.events.count('propertyChange:resultCount', outline._searchStateResultCountChangedHandler)).toBe(0);
      expect(searchPage.searchState.events.count('propertyChange:limited', outline._searchStateLimitedChangedHandler)).toBe(0);
      expect(searchPage.searchState.events.count('propertyChange:pending', outline._searchStatePendingChangedHandler)).toBe(0);
      ...
      expect(searchPage.searchState.events.count('propertyChange:resultCount', outline._searchStateResultCountChangedHandler)).toBe(1);
      expect(searchPage.searchState.events.count('propertyChange:limited', outline._searchStateLimitedChangedHandler)).toBe(1);
      expect(searchPage.searchState.events.count('propertyChange:pending', outline._searchStatePendingChangedHandler)).toBe(1);
  ...
  class SpecSearchOutline extends SearchOutline {
    ...
    declare _searchStateResultCountChangedHandler: typeof this._onSearchStateResultCountChanged;
    declare _searchStateLimitedChangedHandler: typeof this._onSearchStateLimitedChanged;
    declare _searchStatePendingChangedHandler: typeof this._onSearchStatePendingChanged;
    ...
    override _addSearchState(searchState: SearchState) {
      super._addSearchState(searchState);
    }

    override _removeSearchState(searchState: SearchState) {
      super._removeSearchState(searchState);
    }
  }
