 ...
 * <p>
 * Injectable constructors are annotated with {@code @Inject} and accept zero or more dependencies as arguments.
 ...
 * <p>
 * {@code @Inject} is optional for public, no-argument constructors when no other constructors are present. This enables
 ...
 * <p>
 * The injector ignores the result of an injected method, but non-{@code void} return types are allowed to support use
 * of the method in other contexts (builder-style method chaining, for example).
 * <p>
 * Examples:
 *
 * <pre>
 ...
 * injected once per injection request per instance. A method with <i>no</i> {@code @Inject} annotation that overrides a
 * method annotated with {@code @Inject} will not be injected.
 * <p>
 * Injection of members annotated with {@code @Inject} is required. While an injectable member may use any accessibility
 * modifier (including <tt>private</tt>), platform or injector limitations (like security restrictions or lack of
 ...
 * </pre>
 * <p>
 * If one injectable method overrides another, the overriding method's parameters do not automatically inherit
 ...
 * </pre>
 * <p>
 * When constructing an instance of {@code A}, a naive injector implementation might go into an infinite loop
 * constructing an instance of {@code B} to set on {@code A}, a second instance of {@code A} to set on {@code B}, a
