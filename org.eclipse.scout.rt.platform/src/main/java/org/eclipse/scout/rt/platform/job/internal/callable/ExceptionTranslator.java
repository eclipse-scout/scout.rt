...
public class ExceptionTranslator<RESULT> implements Callable<RESULT>, Chainable<RESULT> {
   ...
   */
  public ExceptionTranslator(final Callable<RESULT> next, final JobInput input) {
    m_input = input;
  ...
  public static ProcessingException translate(final Throwable t) {
    ...
    else if (t instanceof AssertionException) {
      throw (AssertionException) t;
    }
    else if (t instanceof ContextInvocationException) {
      return ExceptionTranslator.translate(t.getCause());
    }
