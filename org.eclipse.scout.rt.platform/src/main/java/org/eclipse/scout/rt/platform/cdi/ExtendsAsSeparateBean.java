 ...
 * {@link IBeanContext}
 * <p>
 * {@link OBJ#one(Class)} with A.class will yield an instance of B.
 * <p>
 * However, sometimes it is not intended that B is replacing A in the {@link IBeanContext}, it even has the same
 * {@link Priority}.
 * <p>
 * {@link OBJ#one(Class)} with A.class should yield an instance of A whereas {@link OBJ#one(Class)} with B.class should
