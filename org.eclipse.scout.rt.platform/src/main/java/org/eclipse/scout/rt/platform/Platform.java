...
public final class Platform {
   ...
   *         <p>
   *         The platform is automatically started on the first hit of this {@link Platform} class by the class
   *         initializer.
   *         <p>
  ...
  static {
    ...
    CountDownLatch waitForStartLockAcquire = new CountDownLatch(1);
    new PlatformStarter(platform, waitForStartLockAcquire).start();
    try {
      waitForStartLockAcquire.await();
    }
