...
public enum MimeType implements IMimeType {
  ...
  AVI("video/avi", "avi"),
  AVIF("image/avif", "avif", IMimeMagic.AVIF),
  ...
  EML("message/rfc822", "eml", IMimeMagic.EML),
  ...
  FLV("video/x-flv", "flv", IMimeMagic.FLV), // flash video
  GIF("image/gif", "gif", IMimeMagic.GIF),
  GZ("application/gzip", "gz", IMimeMagic.GZ),
  XZ("application/x-xz", "xz", IMimeMagic.XZ),
  HTML("text/html", "html"),
  HTM("text/html", "htm"),
  ...
  WEBM("video/webm", "webm", IMimeMagic.MKV),
  ...
  RAR("application/vnd.rar", "rar", IMimeMagic.RAR),
  HEIC("image/heic", "heic", IMimeMagic.HEIC),
  CLASS("application/java-vm", "class", IMimeMagic.CLASS),
  FLAC("audio/flac", "flac", IMimeMagic.FLAC),
  TAR("application/x-tar", "tar", IMimeMagic.TAR),
  SEVEN_ZIP("application/x-7z-compressed", "7z", IMimeMagic.SEVEN_ZIP);
