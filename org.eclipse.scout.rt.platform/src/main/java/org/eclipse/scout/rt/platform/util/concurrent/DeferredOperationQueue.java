...
public class DeferredOperationQueue<E> {
  ...
  public DeferredOperationQueue(String transactionMemberId, int batchSize, long maxDelayMillis, Consumer<List<E>> batchOperation, Supplier<RunContext> runContextSupplier) {
    this(transactionMemberId, batchSize, maxDelayMillis, batchOperation, runContextSupplier, transactionMemberId);
  }

  public DeferredOperationQueue(String transactionMemberId, int batchSize, long maxDelayMillis, Consumer<List<E>> batchOperation, String flushJobName) {
    this(transactionMemberId, batchSize, maxDelayMillis, batchOperation, null, flushJobName);
  }
