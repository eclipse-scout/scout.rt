 ...
 * <p/>
 * <code>org.eclipse.scout.platform.serialization.CustomObjectSerializerFactory</code>
 *
 * @since 3.8.2
 */
public final class SerializationUtility {
  ...
  private static IObjectSerializerFactory createObjectSerializerFactory() {
    ...
    try {
      Class<?> customSerializerFactory = Class.forName("org.eclipse.scout.platform.serialization.CustomObjectSerializerFactory");
