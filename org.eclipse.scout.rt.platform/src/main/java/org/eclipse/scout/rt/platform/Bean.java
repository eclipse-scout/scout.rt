 ...
 * all relevant beans in this maven module with {@link IBeanContext#registerClass(Class)}. <br/>
 ...
 * handles special persons. So {@link OBJ#get(Class)} of PersonForm.class should yield an instance of PersonForm whereas
 * {@link OBJ#get(Class)} of VIPPersonForm.class should yield an instance of VIPPersonForm.
 * <p>
 * On the other hand consider the case of <code>PersonForm</code> and <code>PersonFormEx extends PersonForm</code> with
 * the goal of replacing the former PersonForm. Here {@link OBJ#get(Class)} of PersonForm.class should yield an instance
 * of PersonFormEx and also {@link OBJ#get(Class)} of PersonFormEx.class should yield an instance of PersonFormEx.
 * <p>
 * How could the {@link IBeanContext} know which is the case?
 * <p>
 ...
 * annotation to express the semantics of replacing PersonForm. With that annotation {@link IBeanContext} eliminates the
 * subclassed class and only retains the new subclassing class as runtime.
 * <p>
 * Without that annotation {@link IBeanContext} considers both the subclassed and the subclassing class as two beans
