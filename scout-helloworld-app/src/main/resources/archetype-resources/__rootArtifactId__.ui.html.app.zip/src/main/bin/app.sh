...
${symbol_dollar}JAVA_BIN ${symbol_dollar}JVM_ARGS -classpath ${symbol_dollar}CLASSPATH org.eclipse.scout.rt.app.Application >> logs/app.out 2>&1 &
echo ${symbol_dollar}! > bin/app.pid
