...
scout.PopupWithHead.prototype._$createBody = function() {
  ...
  // Create htmlComp for $body to complete the  htmlComp hierarchy between popup and menu items
  var bodyHtmlComp = new scout.HtmlComponent(this.$body, this.session);
  bodyHtmlComp.setLayout(new scout.NullLayout());
