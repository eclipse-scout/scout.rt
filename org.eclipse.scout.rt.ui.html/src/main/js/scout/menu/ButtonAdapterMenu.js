 ...
 * @override Action.js
 */
scout.ButtonAdapterMenu.prototype.init = function(model, session) {
  scout.ButtonAdapterMenu.parent.prototype.init.call(this, model, session);
  if (!this.button) {
...
scout.ButtonAdapterMenu.adaptButtonProperties = function(buttonProperties, menuProperties) {
  ...
  ['enabled', 'visible', 'selected', 'keyStroke', 'keyStrokes', 'modelClass', 'classId'].forEach(function(prop) {
