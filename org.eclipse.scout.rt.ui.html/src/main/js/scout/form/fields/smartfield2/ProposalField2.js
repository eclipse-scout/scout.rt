...
scout.ProposalField2.prototype._lookupByTextOrAllDone = function(result) {
  if (scout.ProposalField2.parent.prototype._handleException.call(this, result)) {
    return;
  }
 ...
 */
scout.ProposalField2.prototype._acceptByText = function(sync, searchText) {
  ...
  if (async && this.lookupOnAcceptByText && scout.strings.hasText(searchText)) {
    scout.ProposalField2.parent.prototype._acceptByTextAsync.call(this, searchText);
  } else {
...
scout.ProposalField2.prototype._acceptInput = function(sync, searchText, searchTextEmpty, searchTextChanged, selectedLookupRow) {
