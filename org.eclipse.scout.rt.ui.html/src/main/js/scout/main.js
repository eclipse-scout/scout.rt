...
scout = {
   ...
   */
  addAppListener: function(type, func) {
    var listener = {
      type: type,
      func: func
    };
   ...
   */
  assertParameter: function(parameterName, value, type) {
   ...
   * @return the value (for direct assignment)
   */
  assertProperty: function(object, propertyName, type) {
   ...
   * @returns {object}
   */
  create: function(objectType, model, options) {
   ...
   */
  prepareDOM: function(targetDocument) {
   ...
   */
  installGlobalMouseDownInterceptor: function(myDocument) {
   ...
   */
  installSyntheticActiveStateHandler: function(myDocument) {
   ...
   */
  widget: function(widgetIdOrElement, partId) {
   ...
   */
  adapter: function(adapterId, partId) {
   ...
   * @param adapterId
   */
  exportAdapter: function(adapterId, partId) {
    var session = scout.getSession(partId);
    if (session && session.modelAdapterRegistry) {
