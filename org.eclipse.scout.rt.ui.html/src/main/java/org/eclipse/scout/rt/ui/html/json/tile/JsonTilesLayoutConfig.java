...
public class JsonTilesLayoutConfig extends JsonLogicalGridLayoutConfig {

  public JsonTilesLayoutConfig(LogicalGridLayoutConfig layoutConfig) {
    super(layoutConfig);
  }

  @Override
  public TilesLayoutConfig getLayoutConfig() {
    return (TilesLayoutConfig) super.getLayoutConfig();
  }
