...
public class JsonTilesAccordion<T extends ITilesAccordion> extends JsonAccordion<T> {

  public JsonTilesAccordion(T model, IUiSession uiSession, String id, IJsonAdapter<?> parent) {
    super(model, uiSession, id, parent);
  }

  @Override
  public String getObjectType() {
    return "TilesAccordion";
  }
  ...
  protected void initJsonProperties(T model) {
    ...
    putJsonProperty(new JsonProperty<T>(ITilesAccordion.PROP_SELECTABLE, model) {
      @Override
      protected Boolean modelValue() {
        return getModel().isSelectable();
      }
    });
    putJsonProperty(new JsonProperty<T>(ITilesAccordion.PROP_MULTI_SELECT, model) {
      @Override
      protected Boolean modelValue() {
