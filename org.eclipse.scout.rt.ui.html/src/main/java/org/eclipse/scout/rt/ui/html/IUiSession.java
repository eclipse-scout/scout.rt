...
public interface IUiSession {
  ...
  /**
   * Sets the new operating mode (cookie) and triggers a reload of the current page in the browser.
   */
  void updateEnforcedDeviceType(IUiDeviceType enforcedDeviceType);
