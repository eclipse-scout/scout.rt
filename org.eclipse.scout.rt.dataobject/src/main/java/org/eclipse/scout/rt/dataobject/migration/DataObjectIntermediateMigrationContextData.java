 ...
 */
@Bean
public class DataObjectIntermediateMigrationContextData implements IDoStructureMigrationGlobalContextData {
   ...
   * the call to a migrate data object method within {@link DoStructureMigrator} are applied after migrations added
   * here.
   */
