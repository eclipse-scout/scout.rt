...
/**
 * Simple wrapper implementation wrapping a {@link String} value.
 * <p>
 ...
 */
@IdSignature(false)
public final class StringCompositePartId extends AbstractStringId {
  @Serial
  private static final long serialVersionUID = 1L;

  private StringCompositePartId(String id) {
    super(id);
  }

  public static StringCompositePartId of(String value) {
    if (value == null) {
      return null;
    }
    return new StringCompositePartId(value);
  }
}
