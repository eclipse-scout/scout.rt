...
public class DoStructureMigrationDataObjectVisitor extends AbstractDataObjectVisitor {
  ...
  protected final DoStructureMigrationInventory m_migrationInventory;
  ...
  public DoStructureMigrationDataObjectVisitor(DoStructureMigrationContext ctx, NamespaceVersion version) {
    ...
    m_migrationInventory = BEANS.get(DoStructureMigrationInventory.class);

    m_ctx = ctx;
    m_version = version;

    m_migrationHandlerPerTypeName = m_migrationInventory.getMigrationHandlers(version);
  }
  ...
  protected List<IDoStructureMigrationTargetContextData> pushLocalContextData(IDoEntity doEntity) {
    ...
    Set<Class<? extends IDoStructureMigrationTargetContextData>> contextDataClasses = m_migrationInventory.getDoMigrationContextValues(doEntity);
