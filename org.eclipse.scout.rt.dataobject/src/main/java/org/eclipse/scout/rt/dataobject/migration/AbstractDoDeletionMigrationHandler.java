 ...
 * When a data object with type version is deleted (i.e. a sub-class of {@link IDoEntity} with a {@link @TypeVersion} annotation) and was part of another data object, make sure to implement a {@link IDoStructureMigrationHandler} which
 * migrates and removes the respective data objects. In addition, implement a sub-class of {@link AbstractDoDeletionMigrationHandler} to ensure that all occurrences of the deleted {@link IDoEntity} class have been removed.
 */
