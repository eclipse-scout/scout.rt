...
import {DateFormat, dates, objects, strings} from '@eclipse-scout/core';

/**
 * @returns {DateAdapter}
 */
export function getAdapter(session) {
  return /** @type {DateAdapter} */ {
    formats: () => _getFormats(session.locale),
 ...
 */
function _getNumberOfDays(month, year) {
