...
public class ArrayComparator implements Comparator<Object[]> {
  ...
  public int compare(Object[] a, Object[] b) {
    ...
    for (int i = 0; i < m_sortColumns.length && m_sortColumns[i] < a.length && m_sortColumns[i] < b.length; i++) {
      ...
      int c = 0;
      if (o1 == null && o2 == null) c = 0;
      else if (o1 == null) c = -1;
      else if (o2 == null && o2 == null) c = 1;
      else if ((o1 instanceof String) && (o2 instanceof String)) c = StringUtility.compareIgnoreCase(m_locale, (String) o1, (String) o2);
      else if ((o1 instanceof Comparable) && (o2 instanceof Comparable)) c = ((Comparable) o1).compareTo(o2);
      else c = StringUtility.compareIgnoreCase(m_locale, o1.toString(), o2.toString());
      if (c != 0) return c;
    }
