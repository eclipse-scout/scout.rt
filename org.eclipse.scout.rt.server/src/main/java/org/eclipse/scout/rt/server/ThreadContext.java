...
public final class ThreadContext {
  ...
  public static HttpServletRequest getHttpServletRequest() {
    return IHttpServletRoundtrip.CURRENT_HTTP_SERVLET_REQUEST.get();
  }
  ...
  public static HttpServletResponse getHttpServletResponse() {
    return IHttpServletRoundtrip.CURRENT_HTTP_SERVLET_RESPONSE.get();
  }
  ...
  public static void putHttpServletRequest(HttpServletRequest value) {
    IHttpServletRoundtrip.CURRENT_HTTP_SERVLET_REQUEST.set(value);
  }
  ...
  public static void putHttpServletResponse(HttpServletResponse value) {
    IHttpServletRoundtrip.CURRENT_HTTP_SERVLET_RESPONSE.set(value);
  }
