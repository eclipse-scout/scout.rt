...
/**
 * In Scout 3.9 AbstractPlannerField will be typed and this class will be removed.
 */
public abstract class AbstractTypedPlannerField<T extends ITable, P extends IActivityMapTyped<RI, AI>, RI, AI> extends AbstractFormField implements ITypedPlannerField<T, P, RI, AI> {
  private static final IScoutLogger LOG = ScoutLogManager.getLogger(AbstractTypedPlannerField.class);
  ...
  public AbstractTypedPlannerField() {
    this(true);
  }

  public AbstractTypedPlannerField(boolean callInitializer) {
  ...
  private Class<? extends IActivityMapTyped> getConfiguredActivityMap() {
    Class[] dca = ConfigurationUtility.getDeclaredPublicClasses(getClass());
    return ConfigurationUtility.filterClass(dca, IActivityMapTyped.class);
  }
   ...
   * {@link ActivityCellTyped}, maps to resources using the resourceId, and sets the {@link ActivityCellTyped}s on the
  ...
  protected void execPopulateActivities(RI[] resourceIds, ITableRow[] resourceRows) throws ProcessingException {
    ...
    ArrayList<ActivityCellTyped<RI, AI>> list = new ArrayList<ActivityCellTyped<RI, AI>>();
    for (Object[] row : data) {
      ActivityCellTyped<RI, AI> cell = new ActivityCellTyped<RI, AI>(row);
      list.add(cell);
    }
    getActivityMap().removeActivityCells(resourceIds);
    getActivityMap().addActivityCells(list.toArray(new ActivityCellTyped[list.size()]));
  }
  ...
  protected void initConfig() {
    ...
    if (getConfiguredActivityMap() != null) {
      ...
      LOG.warn("there is no inner class of type IActivityMapTyped in " + getClass());
    }
    ...
    m_activityMap.addPropertyChangeListener(
        new PropertyChangeListener() {
          ...
          public void propertyChange(PropertyChangeEvent e) {
            if (e.getPropertyName().equals(IActivityMapTyped.PROP_SELECTED_RESOURCE_IDS)) {
  ...
  @Override
  public ITableRow activityCellToResourceRow(ActivityCellTyped<RI, AI> activityCell) {
  ...
  @Override
  public ITableRow[] activityCellsToResourceRows(ActivityCellTyped<RI, AI>[] activityCells) {
    HashSet<ITableRow> resourceRowSet = new HashSet<ITableRow>();
    for (ActivityCellTyped<RI, AI> cell : activityCells) {
  ...
  @Override
  public ActivityCellTyped<RI, AI>[] resourceRowToActivityCells(ITableRow resourceRow) {
    return resourceRowsToActivityCells(new ITableRow[]{resourceRow});
  }

  @Override
  public ActivityCellTyped<RI, AI>[] resourceRowsToActivityCells(ITableRow[] resourceRows) {
