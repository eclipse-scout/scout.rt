...
/**
 * In Scout 3.9 TimeScaleBuilder will be typed and this class will be removed.
 */
public class TimeScaleBuilderTyped {
  private IActivityMapTyped m_map;

  public TimeScaleBuilderTyped(IActivityMapTyped map) {
    m_map = map;
  }
  ...
  public TimeScale build() {
    ...
    switch (m_map.getPlanningMode()) {
      case IActivityMapTyped.PLANNING_MODE_INTRADAY: {
        set = new IntradayTimeScale();
        buildIntradayScale(days, set);
        break;
      }
      case IActivityMapTyped.PLANNING_MODE_DAY: {
        set = new TimeScale();
        buildDayScale(days, set);
        break;
      }
      case IActivityMapTyped.PLANNING_MODE_WEEK: {
        set = new TimeScale();
