...
public class ScoutInfoForm extends AbstractForm {
  ...
  protected void createHtmlBody(StringBuffer buf) {
    ...
    buf.append("<tr><td>" + ScoutTexts.get("DetailedVersion") + ":</td><td>&nbsp;</td><td>" + StringUtility.htmlEncode(v.toString()) + "</td></tr>");
    //
    buf.append("</table>");
  }
  ...
  protected void createHtmlPropertyTableContent(StringBuffer buf) {
    ...
    //
    buf.append("<tr><td>" + ScoutTexts.get("Username") + ":</td><td>&nbsp;</td><td>" + StringUtility.htmlEncode(session.getUserId()) + "</td></tr>");
    buf.append("<tr><td>" + ScoutTexts.get("Language") + ":</td><td>&nbsp;</td><td>" + StringUtility.htmlEncode(LocaleThreadLocal.get().getDisplayLanguage()) + "</td></tr>");
    buf.append("<tr><td>" + ScoutTexts.get("FormattingLocale") + ":</td><td>&nbsp;</td><td>" + StringUtility.htmlEncode(LocaleThreadLocal.get().toString()) + "</td></tr>");
    ...
    if (UserAgentUtility.isRichClient()) {
      buf.append("<tr><td>" + ScoutTexts.get("JavaVersion") + ":</td><td>&nbsp;</td><td>" + StringUtility.htmlEncode(System.getProperty("java.version")) + "</td></tr>");
      buf.append("<tr><td>" + ScoutTexts.get("JavaVMVersion") + ":</td><td>&nbsp;</td><td>" + StringUtility.htmlEncode(System.getProperty("java.vm.version")) + "</td></tr>");
      buf.append("<tr><td>" + ScoutTexts.get("OSVersion") + ":</td><td>&nbsp;</td><td>" + StringUtility.htmlEncode(System.getProperty("os.name") + " " + System.getProperty("os.version")) + "</td></tr>");
      buf.append("<tr><td>" + ScoutTexts.get("OSUser") + ":</td><td>&nbsp;</td><td>" + StringUtility.htmlEncode(System.getProperty("user.name")) + "</td></tr>");
      ...
      if (session.getServiceTunnel() != null && session.getServiceTunnel().getServerURL() != null) {
        buf.append("<tr><td>" + ScoutTexts.get("Server") + ":</td><td>&nbsp;</td><td>" + StringUtility.htmlEncode(session.getServiceTunnel().getServerURL().toString()) + "</td></tr>");
      }
    }
  }
