...
/**
 * In Scout 3.9 ActivityCell will be typed and this class will be removed.
 * Representation of an activity containing an ActivityData
 */
public class ActivityCellTyped<RI, AI> extends MemoryOptimizedObject {
  ...
  private ActivityCellTyped() {
  }

  public ActivityCellTyped(RI resourceId, AI activityId) {
   ...
   * @param minorValue
   */
  public ActivityCellTyped(RI resourceId, AI activityId, Date startTime, Date endTime, String text, String tooltipText, String iconId, float majorValue, float minorValue) {
    setValueInternal(RESOURCE_ID_BIT, resourceId);
    setValueInternal(ACTIVITY_ID_BIT, activityId);
   ...
   *          </ul>
   */
  public ActivityCellTyped(Object[] row) {
  ...
  public IActivityCellObserverTyped<RI, AI> getObserver() {
    return (IActivityCellObserverTyped) getValueInternal(OBSERVER_BIT);
  }

  public void setObserver(IActivityCellObserverTyped<RI, AI> observer) {
