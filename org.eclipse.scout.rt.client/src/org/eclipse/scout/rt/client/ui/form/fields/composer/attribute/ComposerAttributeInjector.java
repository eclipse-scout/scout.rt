 ...
 *
 */
public class ComposerAttributeInjector implements ComposerConstants {
  ...
  public void injectOperators(IComposerAttribute attribute) {
    ...
    switch (attribute.getType()) {
      ...
      case IComposerAttribute.TYPE_TIME: {
        ...
        opList.add(ComposerOp.create(OPERATOR_BETWEEN));
      ...
      case IComposerAttribute.TYPE_DATE: {
        opList.add(ComposerOp.create(OPERATOR_DATE_EQ));
        if (attribute.isNotOperatorEnabled()) {
          opList.add(ComposerOp.create(OPERATOR_DATE_NEQ));
        }
        opList.add(ComposerOp.create(OPERATOR_DATE_BETWEEN));
        opList.add(ComposerOp.create(OPERATOR_DATE_LT));
        opList.add(ComposerOp.create(OPERATOR_DATE_LE));
        opList.add(ComposerOp.create(OPERATOR_DATE_GT));
        opList.add(ComposerOp.create(OPERATOR_DATE_GE));
        if (attribute.isNullOperatorEnabled()) {
          opList.add(ComposerOp.create(OPERATOR_NULL));
        }
        if (attribute.isNotOperatorEnabled() && attribute.isNullOperatorEnabled()) {
      ...
      case IComposerAttribute.TYPE_DATE_TIME: {
        opList.add(ComposerOp.create(OPERATOR_DATE_TIME_EQ));
        if (attribute.isNotOperatorEnabled()) {
          opList.add(ComposerOp.create(OPERATOR_DATE_TIME_NEQ));
        }
        opList.add(ComposerOp.create(OPERATOR_DATE_TIME_BETWEEN));
        opList.add(ComposerOp.create(OPERATOR_DATE_TIME_LT));
        opList.add(ComposerOp.create(OPERATOR_DATE_TIME_LE));
        opList.add(ComposerOp.create(OPERATOR_DATE_TIME_GT));
        opList.add(ComposerOp.create(OPERATOR_DATE_TIME_GE));
        if (attribute.isNullOperatorEnabled()) {
          opList.add(ComposerOp.create(OPERATOR_NULL));
        }
        if (attribute.isNotOperatorEnabled() && attribute.isNullOperatorEnabled()) {
      ...
      case IComposerAttribute.TYPE_STRING: {
        ...
        opList.add(ComposerOp.create(OPERATOR_LIKE));
        if (attribute.isNotOperatorEnabled()) {
