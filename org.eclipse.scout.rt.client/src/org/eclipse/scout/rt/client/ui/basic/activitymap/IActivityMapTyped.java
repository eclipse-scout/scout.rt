...
/**
 * In Scout 3.9 IActivityMap will be typed and this class will be removed.
 * The activity map is a specialized model which contains a set of {@link ActivityCellTyped}s that are grouped by
 * resourceId.
 */
public interface IActivityMapTyped<RI, AI> extends IPropertyObserver {
  ...
  /**
   * {@link ActivityCellTyped}
   */
  String PROP_SELECTED_ACTIVITY_CELL = "selectedActivityCellTyped";
  /**
   * {@link TimeScale}
   */
  ...
  void addActivityMapListener(ActivityMapListenerTyped listener);

  void removeActivityMapListener(ActivityMapListenerTyped listener);
  ...
  void decorateActivityCellTyped(ActivityCellTyped<RI, AI> p);
  ...
  ActivityCellTyped<RI, AI> resolveActivityCellTyped(ActivityCellTyped<RI, AI> cell);

  ActivityCellTyped<RI, AI>[] resolveActivityCells(ActivityCellTyped<RI, AI>[] cells);

  ActivityCellTyped<RI, AI>[] getActivityCells(RI resourceId);

  ActivityCellTyped<RI, AI>[] getActivityCells(RI[] resourceIds);

  ActivityCellTyped<RI, AI>[] getAllActivityCells();

  void addActivityCells(ActivityCellTyped<RI, AI>[] cells);

  void updateActivityCells(ActivityCellTyped<RI, AI>[] cells);

  void updateActivityCells(RI[] resourceIds);

  void removeActivityCells(ActivityCellTyped<RI, AI>[] cells);

  void removeActivityCells(RI[] resourceIds);

  void removeAllActivityCells();

  ActivityCellTyped<RI, AI> getSelectedActivityCellTyped();

  void setSelectedActivityCellTyped(ActivityCellTyped<RI, AI> cell);

  boolean isSelectedActivityCellTyped(ActivityCellTyped<RI, AI> cell);
  ...
  IActivityMapUIFacadeTyped getUIFacade();
