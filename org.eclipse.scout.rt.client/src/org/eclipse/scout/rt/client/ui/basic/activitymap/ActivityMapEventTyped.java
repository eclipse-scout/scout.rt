...
/**
 * In Scout 3.9 ActivityMapEvent will be typed and this class will be removed.
 * 
 * @param <RI>
 */
@SuppressWarnings("serial")
public class ActivityMapEventTyped<RI> extends java.util.EventObject {
  /**
  ...
  private int m_type;
  private ActivityCellTyped[] m_activities = new ActivityCellTyped[0];
  private List<IMenu> m_popupMenus;
  private RI m_resourceId;
  private MinorTimeColumn m_column;

  public ActivityMapEventTyped(IActivityMapTyped source, int type) {
    super(source);
    m_type = type;
  }

  public ActivityMapEventTyped(IActivityMapTyped source, int type, ActivityCellTyped activity) {
    super(source);
    m_type = type;
    if (activity != null) {
      m_activities = new ActivityCellTyped[]{activity};
    }
  }

  public ActivityMapEventTyped(IActivityMapTyped source, int type, ActivityCellTyped[] activities) {
    super(source);
    m_type = type;
  ...
  public ActivityMapEventTyped(IActivityMapTyped source, int type, RI resourceId, MinorTimeColumn column, ActivityCellTyped activity) {
    super(source);
    m_type = type;
    if (activity != null) {
      m_activities = new ActivityCellTyped[]{activity};
  ...
  public IActivityMapTyped getActivityMap() {
    return (IActivityMapTyped) getSource();
  }
  ...
  public ActivityCellTyped[] getActivities() {
    return m_activities;
  }

  protected void setActivities(ActivityCellTyped[] activities) {
    m_activities = activities;
  }
  ...
  public ActivityCellTyped getFirstActivity() {
    return m_activities.length > 0 ? m_activities[0] : null;
  }

  public ActivityCellTyped getLastActivity() {
