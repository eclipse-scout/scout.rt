...
public class ServiceTunnelInvocationHandler implements InvocationHandler {
  ...
  private Class<?> m_serviceInterfaceClass;
  private IServiceTunnel m_tunnel;
  ...
  public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
    ...
    if (Object.class.isAssignableFrom(method.getDeclaringClass())) {
      if (LOG.isDebugEnabled()) {
        LOG.debug("Tunneling " + m_serviceInterfaceClass + "," + method.getName() + "," + VerboseUtility.dumpObjects(args));
      }
