...
public final class SmartField2Chains {

  private SmartField2Chains() {
  }

  protected abstract static class AbstractSmartField2Chain<VALUE> extends AbstractExtensionChain<ISmartField2Extension<VALUE, ? extends AbstractSmartField2<VALUE>>> {

    public AbstractSmartField2Chain(List<? extends IFormFieldExtension<? extends AbstractFormField>> extensions) {
      super(extensions, ISmartField2Extension.class);
    }
  }
