...
public class SmartFieldContentAssistAdapter<VALUE> implements IContentAssistField<VALUE, VALUE> {

  private final ISmartField m_field;

  public SmartFieldContentAssistAdapter(ISmartField field) {
    m_field = field;
  }
