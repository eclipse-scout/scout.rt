...
public interface ITileAccordionGroupManager<T extends ITile> {
  ...
  /**
   * Creates a list of group templates which is used to create instances of {@link IGroup} widgets later. These groups
   * are considered static meaning they won't be deleted if they don't contain any tiles.
   * <p>
   ...
   * added and may not assigned to an existing group. And it will be deleted if all tiles are deleted from that group.
   * If you need static groups, use {@link #createGroups()} instead.
   * <p>
