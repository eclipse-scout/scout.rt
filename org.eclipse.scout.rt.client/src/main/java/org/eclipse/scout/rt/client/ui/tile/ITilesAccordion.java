...
public interface ITilesAccordion<T extends ITile> extends IAccordion {
   ...
   */
  void setGroupManager(ITilesAccordionGroupManager<T> groupManager);

  /**
   * @returns the active group manager
   */
  ITilesAccordionGroupManager<T> getGroupManager();

  void addGroupManager(ITilesAccordionGroupManager<T> groupManager);

  void removeGroupManager(ITilesAccordionGroupManager<T> groupManager);
  ...
  /**
   * @return the value of {@link ITiles#getGridColumnCount()} of the first tile grid assuming that all tile grids use
  ...
  /**
   * @return the value of {@link ITiles#isMultiSelect()} of the first tile grid assuming that all tile grids use the
   *         same value
   */
  ...
  /**
   * @return the value of {@link ITiles#isWithPlaceholders()} of the first tile grid assuming that all tile grids use
   *         the same value
   */
  boolean isWithPlaceholders();

  void setTileGridLayoutConfig(TilesLayoutConfig layoutConfig);

  /**
   * @return the value of {@link ITiles#getLayoutConfig()} of the first tile grid assuming that all tile grids use the
   *         same value
   */
  TilesLayoutConfig getTileGridLayoutConfig();
