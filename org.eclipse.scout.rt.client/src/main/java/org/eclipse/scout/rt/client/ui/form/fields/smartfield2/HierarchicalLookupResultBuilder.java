...
public class HierarchicalLookupResultBuilder<VALUE> {
  ...
  private final ISmartField2<VALUE> m_smartField;

  private ILookupRowProvider<VALUE> m_lookupRowProvider;

  private final Map<VALUE, ILookupRow<VALUE>> m_keyCache = new HashMap<>();

  public HierarchicalLookupResultBuilder(ISmartField2<VALUE> smartField) {
  ...
  private class P_KeyLookupRowProvider implements ILookupRowProvider<VALUE> {
  ...
  private class P_BrowseLookupRowProvider implements ILookupRowProvider<VALUE> {
