...
public class BasicPropertySupportFactory {
  ...
  public BasicPropertySupport createFor(AbstractPropertyObserver holder) {
    ...
    Map<String, Object> defaultValues = switch (holder) {
      case AbstractMenu _ -> m_defaultValuesByClass.computeIfAbsent(AbstractMenu.class, _ -> createDefaultValueMapForAbstractMenu());
      case AbstractColumn _ -> m_defaultValuesByClass.computeIfAbsent(AbstractColumn.class, _ -> createDefaultValueMapForAbstractColumn());
      case AbstractButton _ -> m_defaultValuesByClass.computeIfAbsent(AbstractButton.class, _ -> createDefaultValueMapForAbstractButton());
      case AbstractGroupBox _ -> m_defaultValuesByClass.computeIfAbsent(AbstractGroupBox.class, _ -> createDefaultValueMapForAbstractGroupBox());
      case AbstractBasicField<?> _ -> m_defaultValuesByClass.computeIfAbsent(AbstractBasicField.class, _ -> createDefaultValueMapForAbstractBasicField());
      case AbstractValueField<?> _ -> m_defaultValuesByClass.computeIfAbsent(AbstractValueField.class, _ -> createDefaultValueMapForAbstractValueField());
      case AbstractFormField _ -> m_defaultValuesByClass.computeIfAbsent(AbstractFormField.class, _ -> createDefaultValueMapForAbstractFormField());
      case AbstractAction _ -> m_defaultValuesByClass.computeIfAbsent(AbstractAction.class, _ -> createDefaultValueMapForAbstractAction());
      case AbstractTable _ -> m_defaultValuesByClass.computeIfAbsent(AbstractTable.class, _ -> createDefaultValueMapForAbstractTable());
      case AbstractWidget _ -> m_defaultValuesByClass.computeIfAbsent(AbstractWidget.class, _ -> createDefaultValueMapForAbstractWidget()); // fallback: AbstractWidget
      case HeaderCell _ -> m_defaultValuesByClass.computeIfAbsent(HeaderCell.class, _ -> createDefaultValueMapForHeaderCell());
      default -> null;
    };
  ...
  protected Map<String, Object> createDefaultValueMapForHeaderCell() {
    ...
    defaultValues.put(HeaderCell.PROP_TEXT, null);
    defaultValues.put(HeaderCell.PROP_TOOLTIP_HTML_ENABLED, false);
    defaultValues.put(HeaderCell.PROP_ICON_ID, null);
    defaultValues.put(HeaderCell.PROP_CSS_CLASS, null);
    defaultValues.put(HeaderCell.PROP_HTML_ENABLED, false);
    defaultValues.put(HeaderCell.PROP_MENU_ENABLED, true);
    defaultValues.put(HeaderCell.PROP_HORIZONTAL_ALIGNMENT, -1);
    return Collections.unmodifiableMap(defaultValues);
  }

  protected Map<String, Object> createDefaultValueMapForAbstractColumn() {
    HashMap<String, Object> defaultValues = new HashMap<>();
    defaultValues.put(IColumn.PROP_AUTO_OPTIMIZE_WIDTH, false);
    defaultValues.put(IColumn.PROP_HORIZONTAL_ALIGNMENT, -1);
    defaultValues.put(IColumn.PROP_VISIBLE, true);
    defaultValues.put(IColumn.PROP_ORDER, IOrdered.DEFAULT_ORDER);
    defaultValues.put(IColumn.PROP_WIDTH, 60);
    defaultValues.put(IColumn.PROP_MIN_WIDTH, 60);
    defaultValues.put(IColumn.PROP_AUTO_OPTIMIZE_MAX_WIDTH, -1);
    defaultValues.put(IColumn.PROP_FIXED_WIDTH, false);
    defaultValues.put(IColumn.PROP_FIXED_POSITION, false);
    defaultValues.put(IColumn.PROP_EDITABLE, false);
    defaultValues.put(IFormField.PROP_MANDATORY, false);
    defaultValues.put(IColumn.PROP_VIEW_COLUMN_INDEX_HINT, -1);
    defaultValues.put(IColumn.PROP_CSS_CLASS, null);
    defaultValues.put(IStringField.PROP_WRAP_TEXT, false);
    defaultValues.put(IColumn.PROP_HTML_ENABLED, false);
    defaultValues.put(IColumn.PROP_UI_SORT_POSSIBLE, false);
    defaultValues.put(IColumn.PROP_NODE_COLUMN_CANDIDATE, true);
    return Collections.unmodifiableMap(defaultValues);
  }
  ...
  protected Map<String, Object> createDefaultValueMapForAbstractTable() {
    ...
    defaultValues.put(ITable.PROP_ROWS_DRAGGABLE, false);
    return Collections.unmodifiableMap(defaultValues);
  }

  protected Map<String, Object> createDefaultValueMapForAbstractWidget() {
    HashMap<String, Object> defaultValues = new HashMap<>();
    defaultValues.put(IWidget.PROP_INIT_CONFIG_DONE, true);
    defaultValues.put(IWidget.PROP_INIT_DONE, true);
    defaultValues.put(AbstractWidget.PROP_ENABLED_BYTE, (byte) -1);
    defaultValues.put(IWidget.PROP_INHERIT_ACCESSIBILITY, true);
    defaultValues.put(IWidget.PROP_CSS_CLASS, null);
    defaultValues.put(IWidget.PROP_DISPOSE_DONE, false);
    return Collections.unmodifiableMap(defaultValues);
  }
}
