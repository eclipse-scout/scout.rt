...
public class WizardEvent extends EventObject implements IModelEvent {
  ...
  /**
   * One or more of the following changes occurred (state machine) State transition has occurred, next step was
   * activated (but not run) History has changed Expected future has changed
   */
