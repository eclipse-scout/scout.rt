...
public abstract class AbstractTree extends AbstractWidget implements ITree, IContributionOwner, IExtensibleObject {
  ...
  public void setNodeChecked(ITreeNode node, boolean checked, boolean enabledNodesOnly, boolean forceUpdateNode) {
    setNodesChecked(CollectionUtility.arrayList(node), checked, enabledNodesOnly, forceUpdateNode);
  }
  ...
  public void setNodesChecked(List<ITreeNode> nodes, boolean checked, boolean enabledNodesOnly) {
    setNodesChecked(nodes, checked, enabledNodesOnly, false);
  }
  ...
  public void setNodesChecked(List<ITreeNode> nodes, boolean checked, boolean enabledNodesOnly, boolean forceUpdateNode) {
    ...
    for (ITreeNode node : nodes) {
      node = resolveNode(node);
      if (node != null && (node.isChecked() != checked || forceUpdateNode) && (!enabledNodesOnly || node.isEnabled())) {
        if (checked) {
