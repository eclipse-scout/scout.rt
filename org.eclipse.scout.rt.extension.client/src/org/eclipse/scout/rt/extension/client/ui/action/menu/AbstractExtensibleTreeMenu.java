 ...
 * @since 3.9.0
 */
public abstract class AbstractExtensibleTreeMenu extends AbstractTreeMenu implements IExtensibleScoutObject {

  public AbstractExtensibleTreeMenu() {
    super();
  }

  public AbstractExtensibleTreeMenu(boolean callInitializer) {
