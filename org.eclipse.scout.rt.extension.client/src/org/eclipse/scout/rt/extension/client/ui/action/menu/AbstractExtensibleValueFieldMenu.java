 ...
 * @since 3.9.0
 */
public abstract class AbstractExtensibleValueFieldMenu extends AbstractValueFieldMenu implements IExtensibleScoutObject {

  public AbstractExtensibleValueFieldMenu() {
    super();
  }

  public AbstractExtensibleValueFieldMenu(boolean callInitializer) {
