 ...
 * @since 3.9.0
 */
public abstract class AbstractExtensibleTableMenu extends AbstractTableMenu implements IExtensibleScoutObject {

  public AbstractExtensibleTableMenu() {
    super();
  }

  public AbstractExtensibleTableMenu(boolean callInitializer) {
