...
import org.eclipse.scout.rt.client.ui.basic.activitymap.AbstractActivityMapTyped;
 ...
 * @since 3.9.0
 */
public abstract class AbstractExtensibleActivityMapTyped<RI, AI> extends AbstractActivityMapTyped<RI, AI> implements IExtensibleScoutObject {

  public AbstractExtensibleActivityMapTyped() {
    super();
  }

  public AbstractExtensibleActivityMapTyped(boolean callInitializer) {
