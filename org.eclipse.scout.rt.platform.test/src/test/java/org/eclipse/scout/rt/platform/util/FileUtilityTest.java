...
public class FileUtilityTest {
  ...
  public void testIsZipFile() throws Exception {
    ...
    File noZipFile = null;
    try {
      zipFile = TestUtility.createTempFileFromFilename("org/eclipse/scout/rt/platform/zip.zip", getClass());
      noZipFile = TestUtility.createTempFileFromFilename("org/eclipse/scout/rt/platform/nozip.zip", getClass());
