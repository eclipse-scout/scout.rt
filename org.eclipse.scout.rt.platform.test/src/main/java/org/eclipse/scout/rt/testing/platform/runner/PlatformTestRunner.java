  ...
  protected static class MonitorRuntimeStatement extends Statement {
    ...
    public void evaluate() throws Throwable {
      ...
      if (elapsed > m_timeout) {
        throw new ProcessingException("Test including pre-/post-methods took longer than maximum expected runtime (maximum expected: {}, actual runtime: {}); specify a higher timeout on the @Test method to increase maximum time for specific test methods", m_timeout, elapsed);
      }
    }
  }
}
