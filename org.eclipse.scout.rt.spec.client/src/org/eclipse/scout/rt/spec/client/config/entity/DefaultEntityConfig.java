 ...
 *
 */
public abstract class DefaultEntityConfig<T extends ITypeWithClassId> implements IDocEntityConfig<T> {

  /**
   * Default filters: Ignores Types annotated with {@link Doc#ignore()}==false
   */
  @Override
