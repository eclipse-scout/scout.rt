  ...
  protected T createChart() {
    ...
    if (configuredChart != null) {
      try {
        ...
        BEANS.get(ExceptionHandler.class).handle(new ProcessingException("error creating instance of class '" + configuredChart.getName() + "'.", e));
      }
    }
    return null;
  }
...
//TODO nbu export import
//TODO nbu interception
