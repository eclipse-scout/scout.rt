...
public class SpecUtilityTest {
  ...
  public void testExpandMenuHierarchy() throws ProcessingException {
    IMenu[] menus = SpecUtility.expandMenuHierarchy(new TestForm().getFieldByClass(SmartField.class).getMenus());
    assertEquals(7, menus.length);
    assertTrue(menus[0] instanceof TopMenu1);
    assertTrue(menus[1] instanceof TopExtensibleMenu1);
    assertTrue(menus[2] instanceof SubMenu1);
    assertTrue(menus[3] instanceof TopExtensibleMenu2);
    assertTrue(menus[4] instanceof SubMenu2);
    assertTrue(menus[5] instanceof SubExtensibleMenu);
    assertTrue(menus[6] instanceof SubSubMenu);
  }
