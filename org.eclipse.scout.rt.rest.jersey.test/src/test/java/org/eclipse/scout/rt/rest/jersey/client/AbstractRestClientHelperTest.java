...
public class AbstractRestClientHelperTest {
  ...
  public void testBuildClient() {
    ...
    Set<Class<?>> expectedInstances = Set.of(ObjectMapperResolver.class, AntiCsrfClientFilter.class, HttpHeadersRequestFilter.class, LanguageAndCorrelationIdRestRequestFilter.class, IdSignatureRestClientFilter.class);
