 ...
 * <code>mail.smtp.reportsuccess</code> property is true. It indicates an
 * address to which the message was sent. The command will be an SMTP RCPT
 * command and the return code will be the return code from that command.
 * 
...
public class SMTPAddressSucceededException extends MessagingException{
  ...
  /**
   * Constructs an SMTPAddressSucceededException with the specified address,
   * return code, and error string.
   * 
   * @param addr
  ...
  /**
   * Return the return code from the SMTP server that indicates the reason for
   * the success. See <A HREF="http://www.ietf.org/rfc/rfc821.txt">RFC 821</A>
