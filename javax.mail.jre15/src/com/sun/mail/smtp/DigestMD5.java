...
public class DigestMD5{
  ...
  public byte[] authClient(String host, String user, String passwd,
    ...
    if(debugout != null) debugout.println("DEBUG DIGEST-MD5: Response => "
        + result.toString());
  ...
  public boolean authServer(String serverResponse) throws IOException{
    ...
    if(!text.equals((String)map.get("rspauth"))){
      if(debugout != null) debugout.println("DEBUG DIGEST-MD5: " +
    ...
    while((ttype=tokens.nextToken()) != StreamTokenizer.TT_EOF){
      switch(ttype){
        case StreamTokenizer.TT_WORD:
          ...
          // fall-thru
        case '"':
          if(debugout != null) debugout.println("DEBUG DIGEST-MD5: Received => "
              + key + "='" + tokens.sval + "'");
