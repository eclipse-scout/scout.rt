 ...
 * SMTPAddressSucceededExceptions, * one per address. This exception corresponds
 * to one of the SMTP commands used to send a message, such as the MAIL, DATA,
...
public class SMTPSendFailedException extends SendFailedException{
  ...
  /**
   * Constructs an SMTPSendFailedException with the specified address, return
