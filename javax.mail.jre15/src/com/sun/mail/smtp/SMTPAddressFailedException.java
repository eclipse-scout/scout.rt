 ...
 * <p>
 * The exception includes the address to which the message could not be sent.
 * This will usually appear in a chained list of exceptions, one per address,
 * attached to a top level SendFailedException that aggregates all the
 * addresses.
 * 
...
public class SMTPAddressFailedException extends SendFailedException{
  ...
  /**
   * Constructs an SMTPAddressFailedException with the specified address, return
   ...
   * the failure. See <A HREF="http://www.ietf.org/rfc/rfc821.txt">RFC 821</A>
