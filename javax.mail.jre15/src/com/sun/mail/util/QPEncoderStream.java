...
public class QPEncoderStream extends FilterOutputStream{
   ...
   *          the output stream
   * @param bytesPerLine
   *          the number of bytes per line. The encoder inserts a CRLF sequence
   *          after this many number of bytes.
   */
   ...
   * QPEncoderStream encoder = new QPEncoderStream(System.out); int c; while ((c
