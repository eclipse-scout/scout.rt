...
/**
 * This class implements a Q Encoder as defined by RFC 2047 for encoding MIME
 * headers. It subclasses the QPEncoderStream class.
 * 
 * @author John Mani
 */
...
public class QEncoderStream extends QPEncoderStream{
   ...
   * QEncoderStream encoder = new QEncoderStream(System.out); int c; while ((c =
   * infile.read()) != -1) encoder.write(c); encoder.close(); } end TEST program
   ***/
}
