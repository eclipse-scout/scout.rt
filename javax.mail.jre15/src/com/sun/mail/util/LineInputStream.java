 ...
 * use is to read lines as String objects from a RFC822 stream. It is
 * implemented as a FilterInputStream, so one can just wrap this class around
...
public class LineInputStream extends FilterInputStream{
  ...
  /**
   * Read a line containing only ASCII characters from the input stream. A line
   * is terminated by a CR or NL or CR-NL sequence. A common error is a CR-CR-NL
    ...
    while((c1=in.read()) != -1){
      ...
      break;
        ...
        if(c2 != '\n'){
          ...
          if(!(in instanceof PushbackInputStream)) in=this.in=new PushbackInputStream(in);
