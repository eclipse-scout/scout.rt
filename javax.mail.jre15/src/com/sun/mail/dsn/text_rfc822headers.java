...
public class text_rfc822headers implements DataContentHandler{
  ...
  public Object getTransferData(DataFlavor df, DataSource ds)
    ...
    if(myDF.equals(df)) return getContent(ds);
    else if(myDFs.equals(df)) return getStringContent(ds);
    else return null;
  }
  ...
  private Object getStringContent(DataSource ds) throws IOException{
    ...
    try{
       ...
       * an IllegalArgumentException. The JDK will attempt to create a classname
       * using this string, but valid classnames must not contain the character
       * '-', and this results in an IllegalArgumentException, rather than the
       * expected UnsupportedEncodingException. Yikes.
       */
  ...
  public void writeTo(Object obj, String type, OutputStream os)
    ...
    if(!(obj instanceof String)) throw new IOException("\"" + myDFs.getMimeType() +
