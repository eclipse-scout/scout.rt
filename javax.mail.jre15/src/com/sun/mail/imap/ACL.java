...
/**
 * An access control list entry for a particular authentication identifier (user
 * or group). Associates a set of Rights with the identifier. See RFC 2086.
 * <p>
 * 
 * @author Bill Shannon
 */
...
public class ACL implements Cloneable{
  ...
  /**
   * Get the rights associated with this ACL entry. Returns the actual Rights
   * object referenced by this ACL; modifications to the Rights object will
   * effect this ACL.
   * 
   * @return the rights
   */
