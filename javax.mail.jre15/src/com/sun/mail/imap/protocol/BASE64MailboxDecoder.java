...
/**
 * See the BASE64MailboxEncoder for a description of the RFC2060 and how mailbox
 * names should be encoded. This class will do the correct decoding for mailbox
 * names.
 * 
...
public class BASE64MailboxDecoder{
  ...
  protected static int base64decode(char[] buffer, int offset,
    ...
    while(true){
      ...
      if(orig_1 == -1 || orig_1 == '-') break; // no more chars, invalid base64
   ...
   * but with the modification from RFC2060 which changes the '/' to a ','.
   */
