...
public class IMAPResponse extends Response{
  ...
  /**
   * Read a list of space-separated "flag_extension" sequences and return the
   * list as a array of Strings. An empty list is returned as null. This is an
   * IMAP-ism, and perhaps this method should moved into the IMAP layer.
   */
  ...
  public boolean keyEquals(String k){
    if(key != null && key.equalsIgnoreCase(k)) return true;
    else return false;
  }
  ...
  public static IMAPResponse readResponse(Protocol p)
    ...
    if(r.keyEquals("FETCH")) r=new FetchResponse(r);
    return r;
  }
}
