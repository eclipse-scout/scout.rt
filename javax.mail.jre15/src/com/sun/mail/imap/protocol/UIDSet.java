...
/**
 * This class holds the 'start' and 'end' for a range of UIDs. Just like
 * MessageSet except using long instead of int.
 */
public class UIDSet{
  ...
  public static String toString(UIDSet[] msgsets){
    ...
    for(;;){
      ...
      if(end > start) s.append(start).append(':').append(end);
