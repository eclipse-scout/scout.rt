...
/**
 * A simple wrapper around a byte array, with a start position and count of
 * bytes.
 * 
...
public class ByteArray{
  ...
  /**
   * Returns the internal byte array. Note that this is a live reference to the
   * actual data, not a copy.
   */
