...
public class Argument{
  ...
  /**
   * append the given Argument to this Argument. All items from the source
   * argument are copied into this destination argument.
   */
  ...
  /**
   * Write out given string as an ASTRING, depending on the type of the
   * characters inside the string. The string should contain only ASCII
   * characters.
   * <p>
  ...
  /**
   * Convert the given string into bytes in the specified charset, and write the
   * bytes out as an ASTRING
   */
  public void writeString(String s, String charset)
      throws UnsupportedEncodingException{
    if(charset == null) // convenience
    writeString(s);
    else items.addElement(new AString(s.getBytes(charset)));
  }
   ...
   * 
   * @param b
   *          ByteArrayOutputStream to be written out.
   */
   ...
   * 
   * @param b
   *          Literal representing data to be written out.
   */
   ...
   * certain US-ASCII characters. No validation is done on the characters in the
   * string.
   * 
   * @param s
   *          String
