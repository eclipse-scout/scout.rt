...
/**
 * Package private class used by Store & Folder to dispatch events. This class
 * implements an event queue, and a dispatcher thread that dequeues and
 * dispatches events from the queue. Pieces stolen from sun.misc.Queue.
 * 
 * @author Bill Shannon
 */
      ...
      loop: while((qe=dequeue()) != null){
        ...
        for(int i=0; i < v.size(); i++)
          try{
            ...
            if(t instanceof InterruptedException) break loop;
