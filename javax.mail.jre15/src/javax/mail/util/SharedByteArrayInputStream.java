...
public class SharedByteArrayInputStream extends ByteArrayInputStream
  ...
  /**
   * Create a SharedByteArrayInputStream representing the part of the byte array
   * from <code>offset</code> for <code>length</code> bytes.
   * 
   * @param buf
   *          the byte array
   * @param offset
