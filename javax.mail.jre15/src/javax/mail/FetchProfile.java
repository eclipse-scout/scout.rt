...
/**
 * Clients use a FetchProfile to list the Message attributes that it wishes to
 * prefetch from the server for a range of messages.
 * <p>
...
public class FetchProfile{
  ...
  /**
   * This inner class is the base class of all items that can be requested in a
   * FetchProfile. The items currently defined here are <code>ENVELOPE</code>,
   * <code>CONTENT_INFO</code> and <code>FLAGS</code>. The
   * <code>UIDFolder</code> interface defines the <code>UID</code> Item as well.
   * <p>
  ...
  public static class Item{
     ...
     * Implementations should include the following attributes: From, To, Cc,
     * Bcc, ReplyTo, Subject and Date. More items may be included as well.
     * <p>
     * For implementations of the IMAP4 protocol (RFC 2060), the Envelope should
     * include the ENVELOPE data item. More items may be included too.
     */
  ...
  public void add(Item item){
    if(specials == null) specials=new Vector();
