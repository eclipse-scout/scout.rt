...
public interface Part{
  ...
  /**
   * Return the size of the content of this part in bytes. Return -1 if the size
   * cannot be determined.
   * <p>
   * Note that the size may not be an exact measure of the content size and may
   * or may not account for any transfer encoding of the content. The size is
   * appropriate for display in a user interface to give the user a rough idea
   * of the size of this part.
   * 
   ...
   * number cannot be determined. Note that this number may not be an exact
   * measure of the content length and may or may not account for any transfer
  ...
  /**
   * Return the disposition of this part. The disposition describes how the part
   * should be presented to the user. (See RFC 2183.) The return value should be
   * considered without regard to case. For example:
   * <p>
   * <blockquote>
   * 
   * <pre>
   ...
   * descriptive information with this part. Returns null if none is available.
   * 
  ...
  /**
   * Return the content as a Java object. The type of the returned object is of
   * course dependent on the content itself. For example, the object returned
   * for "text/plain" content is usually a String object. The object returned
   * for a "multipart" content is always a Multipart subclass. For content-types
   * that are unknown to the DataHandler system, an input stream is returned as
   * the content
   * <p>
  ...
  /**
   * A convenience method that sets the given String as this part's content with
   ...
   * aggregration of the Part attributes and an appropriately encoded bytestream
   * from its 'content'.
   * <p>
  ...
  /**
   * Return non-matching headers from this envelope as an Enumeration of Header
   * objects.
   * 
   * @return enumeration of Header objects
   * @exception MessagingException
