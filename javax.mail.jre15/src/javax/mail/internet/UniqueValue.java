...
class UniqueValue{
  ...
  /**
   * Get a unique value for use in a multipart boundary string. This
   * implementation generates it by concatenating a global part number, a newly
   * created object's <code>hashCode()</code>, and the current time (in
   * milliseconds).
   */
  ...
  public static String getUniqueMessageIDValue(Session ssn){
    ...
    if(addr != null) suffix=addr.getAddress();
    else{
