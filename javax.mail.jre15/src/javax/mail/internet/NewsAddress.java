...
public class NewsAddress extends Address{
  ...
  public boolean equals(Object a){
    if(!(a instanceof NewsAddress)) return false;
  ...
  public int hashCode(){
    int hash=0;
    if(newsgroup != null) hash+=newsgroup.hashCode();
    if(host != null) hash+=host.toLowerCase(Locale.ENGLISH).hashCode();
    return hash;
  }
   ...
   *              , if any address object in the given array is not a
   *              NewsAddress objects. Note that this is a RuntimeException.
  ...
  /**
   * Parse the given comma separated sequence of newsgroup into NewsAddress
   * objects.
   * 
   * @param newsgroups
