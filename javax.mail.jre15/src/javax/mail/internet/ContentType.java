...
/**
 * This class represents a MIME ContentType value. It provides methods to parse
 * a ContentType string into individual components and to generate a MIME style
 * ContentType string.
 * 
...
public class ContentType{
   ...
   * constituents: primaryType, subType and parameters. A ParseException is
  ...
  /**
   * Return the MIME type string, without the parameters. The returned value is
   * basically the concatenation of the primaryType, the '/' character and the
   * secondaryType.
   * 
   * @return the type
   */
  ...
  /**
   * Return the specified parameter value. Returns <code>null</code> if this
   * parameter is absent.
   * 
  ...
  /**
   * Set the specified parameter. If this parameter already exists, it is
   ...
   * </strong>. The parameters of both operands are ignored.
   * <p>
   * For example, this method will return <code>true</code> when comparing the
   * ContentTypes for <strong>"text/plain"</strong> and
   * <strong>"text/plain; charset=foobar"</strong>. If the <code>subType</code>
   * of either operand is the special character '*', then the subtype is ignored
   * during the match. For example, this method will return <code>true</code>
   * when comparing the ContentTypes for <strong>"text/plain"</strong> and
   * <strong>"text/*" </strong>
   * 
   * @param cType
  ...
  /**
   * Match with the specified content-type string. This method compares
   * <strong>only the <code>primaryType</code> and <code>subType</code>
   * </strong>. The parameters of both operands are ignored.
   * <p>
   * For example, this method will return <code>true</code> when comparing the
   * ContentType for <strong>"text/plain"</strong> with
   * <strong>"text/plain; charset=foobar"</strong>. If the <code>subType</code>
   * of either operand is the special character '*', then the subtype is ignored
   * during the match. For example, this method will return <code>true</code>
   * when comparing the ContentType for <strong>"text/plain"</strong> with
   * <strong>"text/*" </strong>
   */
