...
/**
 * This class represents a MIME ContentDisposition value. It provides methods to
 * parse a ContentDisposition string into individual components and to generate
 * a MIME style ContentDisposition string.
 * 
...
public class ContentDisposition{
  ...
  /**
   * Constructor that takes a ContentDisposition string. The String is parsed
   * into its constituents: dispostion and parameters. A ParseException is
  ...
  public String toString(){
    ...
    if(list == null) return disposition;
