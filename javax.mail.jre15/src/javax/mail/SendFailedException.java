 ...
 * <p>
 * The exception includes those addresses to which the message could not be sent
 * as well as the valid addresses to which the message was sent and valid
 * addresses to which the message was not sent.
 * 
...
public class SendFailedException extends MessagingException{
  ...
  /**
   * Constructs a SendFailedException with the specified Exception and detail
