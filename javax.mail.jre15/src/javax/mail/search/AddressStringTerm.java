 ...
 * <p>
 * Note that this class differs from the <code>AddressTerm</code> class in that
 * this class does comparisons on address strings rather than Address objects.
 * 
 * @since JavaMail 1.1
 */
...
public abstract class AddressStringTerm extends StringTerm{
   ...
   * <p>
   * Note that if the string representation of the given Address object contains
   * charset or transfer encodings, the encodings must be accounted for, during
   * the match process.
   * <p>
   * 
   * @param a
  ...
  public boolean equals(Object obj){
    if(!(obj instanceof AddressStringTerm)) return false;
