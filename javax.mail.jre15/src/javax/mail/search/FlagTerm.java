...
public final class FlagTerm extends SearchTerm{
   ...
   * Flag. If <code>true</code>, then test whether all the specified flags are
   * present, else test whether all the specified flags are absent.
   * 
   * @serial
   */
   ...
   * 
   * @param flags
   *          Flags object containing the flags to check for
   * @param set
  ...
  public boolean match(Message msg){
    ...
    try{
      ...
      if(set){ // This is easy
        if(f.contains(flags)) return true;
        else return false;
      }
  ...
  public boolean equals(Object obj){
    if(!(obj instanceof FlagTerm)) return false;
