 ...
 * <p>
 * Note that this class differs from the <code>RecipientTerm</code> class in
 * that this class does comparisons on address strings rather than Address
...
public final class RecipientStringTerm extends AddressStringTerm{
  ...
  public boolean match(Message msg){
    ...
    for(int i=0; i < recipients.length; i++)
      if(super.match(recipients[i])) return true;
    return false;
  }
