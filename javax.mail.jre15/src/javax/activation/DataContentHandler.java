...
/**
 * The DataContentHandler interface is implemented by objects that can be used
 * to extend the capabilities of the DataHandler's implementation of the
 * Transferable interface. Through <code>DataContentHandlers</code> the
 * framework can be extended to convert streams in to objects, and to write
 * objects to streams.
 * <p>
 ...
 * DataContentHandler that corresponds to its MIME type using the current
 * DataContentHandlerFactory. The DataHandler then calls through to the methods
 * in the DataContentHandler.
 */
...
public interface DataContentHandler{
   ...
   * 
   * @param df
   *          The DataFlavor representing the requested type.
   * @param ds
   ...
   * Generally this will be the form described by the first DataFlavor returned
   * by the <code>getTransferDataFlavors</code> method.
   * 
   * @param ds
   *          The DataSource representing the data to be converted.
   * @return The constructed Object.
  ...
  /**
   * Convert the object to a byte stream of the specified MIME type and write it
   ...
   * @param os
   *          The output stream into which to write the converted byte stream.
   * @exception IOException
