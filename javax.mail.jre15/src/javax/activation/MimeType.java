...
public class MimeType implements Externalizable{
  ...
  /**
   * Constructor that builds a MimeType with the given primary and sub type but
  ...
  private void parse(String rawdata) throws MimeTypeParseException{
    ...
    // check to see if primary is valid
    if(!isValidToken(primaryType)) throw new MimeTypeParseException("Primary type is invalid.");

    // check to see if sub is valid
    if(!isValidToken(subType)) throw new MimeTypeParseException("Sub type is invalid.");
  }
  ...
  /**
   * Determine if the primary and sub type of this object is the same as what is
   * in the given type.
   * 
   * @param type
  ...
  /**
   * Determine if the primary and sub type of this object is the same as the
   * content type described in rawdata.
   * 
   * @param rawdata
  ...
  /**
   * A simple parser test, for debugging... public static void main(String[]
   * args) throws MimeTypeParseException, IOException { for (int i = 0; i <
   * args.length; ++i) { System.out.println("Original: " + args[i]); MimeType
   * type = new MimeType(args[i]); System.out.println("Short:    " +
   * type.getBaseType()); System.out.println("Parsed:   " + type.toString());
   * System.out.println(); } }
   */
}
