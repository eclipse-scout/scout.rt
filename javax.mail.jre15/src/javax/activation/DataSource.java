 ...
 * data as well as access to it in the form of <code>InputStreams</code> and
...
public interface DataSource{
   ...
   * written and throws the appropriate exception if it can not do so. Note that
   * a new <code>OutputStream</code> object must be returned each time this
   * method is called, and the stream must be positioned at the location the
   ...
   * return "application/octet-stream" if the DataSource implementation can not
   ...
   * (Typically this would be the last component of the filename, not an entire
   * pathname.)
   * 
