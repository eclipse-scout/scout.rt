...
public class MimetypesFileTypeMap extends FileTypeMap{
  ...
  public MimetypesFileTypeMap() {
    ...
    synchronized(MimetypesFileTypeMap.class){
      ...
      if(defDB == null) defDB=loadResource("/META-INF/mimetypes.default");
    }
  ...
  private MimeTypeFile loadResource(String name){
    ...
    try{
      ...
      if(clis != null){
        ...
        if(LogSupport.isLoggable()) LogSupport.log("MimetypesFileTypeMap: successfully " +
            "loaded mime types file: " + name);
        return mf;
      }
      else{
        if(LogSupport.isLoggable()) LogSupport.log("MimetypesFileTypeMap: not loading " +
        ...
        for(int i=0; i < urls.length; i++){
          ...
          try{
            ...
            if(clis != null){
              ...
              anyLoaded=true;
              if(LogSupport.isLoggable()) LogSupport.log("MimetypesFileTypeMap: " +
                  "successfully loaded " +
            ...
            if(LogSupport.isLoggable()) LogSupport.log("MimetypesFileTypeMap: can't load " +
                url, ioex);
          }
          catch(SecurityException sex){
            if(LogSupport.isLoggable()) LogSupport.log("MimetypesFileTypeMap: can't load " +
  ...
  public synchronized void addMimeTypes(String mime_types){
    ...
    if(DB[PROG] == null) DB[PROG]=new MimeTypeFile(); // make one
   ...
   * map.getContentType(argv[0])); System.exit(0); }
   */
}
