...
/**
 * The FileTypeMap is an abstract class that provides a data typing interface
 * for files. Implementations of this class will implement the getContentType
 * methods which will derive a content type from a file name or a File object.
...
public abstract class FileTypeMap{
  ...
  /**
   * Sets the default FileTypeMap for the system. This instance will be returned
   * to callers of getDefaultFileTypeMap.
   * 
   * @param map
   *          The FileTypeMap.
  ...
  public static void setDefaultFileTypeMap(FileTypeMap map){
    ...
    if(security != null){
      try{
        ...
        if(FileTypeMap.class.getClassLoader() != map.getClass().getClassLoader()) throw ex;
      }
    }
    defaultMap=map;
  }
  ...
  public static FileTypeMap getDefaultFileTypeMap(){
    ...
    if(defaultMap == null) defaultMap=new MimetypesFileTypeMap();
    return defaultMap;
  }
}
