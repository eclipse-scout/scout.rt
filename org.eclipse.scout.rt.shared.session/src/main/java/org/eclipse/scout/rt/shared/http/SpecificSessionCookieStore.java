...
/**
  ...
  public class SpecificSessionCookieStore implements CookieStore {
    ...
    protected final ISession m_session;
    protected final CookieStore m_defaultCookieStore;

    public SpecificSessionCookieStore(ISession session, CookieStore defaultCookieStore) {
      m_session = session;
    ...
    protected CookieStore getDefaultCookieStore() {
