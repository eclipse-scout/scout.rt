...
public class ServerJobEventFilterTest {
  ...
  public void testEventTypes() {
    assertFalse(ServerJobs.newEventFilter().andMatchEventType(JobEventType.ABOUT_TO_RUN, JobEventType.DONE).accept(new JobEvent(m_jobManager, JobEventType.SCHEDULED, m_serverJobFuture)));
    assertTrue(ServerJobs.newEventFilter().andMatchEventType(JobEventType.ABOUT_TO_RUN, JobEventType.DONE).accept(new JobEvent(m_jobManager, JobEventType.ABOUT_TO_RUN, m_serverJobFuture)));
    assertTrue(ServerJobs.newEventFilter().andMatchEventType(JobEventType.ABOUT_TO_RUN, JobEventType.DONE).accept(new JobEvent(m_jobManager, JobEventType.DONE, m_serverJobFuture)));
    assertFalse(ServerJobs.newEventFilter().andMatchEventType(JobEventType.ABOUT_TO_RUN, JobEventType.DONE).accept(new JobEvent(m_jobManager, JobEventType.SHUTDOWN, m_serverJobFuture)));
  }
  ...
  public void testShutdownEvent() {
    ...
    assertFalse(ServerJobs.newEventFilter().andMatchEventType(JobEventType.ABOUT_TO_RUN).andMatchSession(m_serverSession1).accept(serverEvent));
    assertFalse(ServerJobs.newEventFilter().andMatchEventType(JobEventType.ABOUT_TO_RUN).andMatchSession(m_serverSession2).accept(serverEvent));
  }
  ...
  public void testFuture() {
    ...
    assertTrue(ServerJobs.newEventFilter().andMatchFuture(m_serverJobFuture, m_jobFuture).accept(serverEvent));
    assertFalse(ServerJobs.newEventFilter().andMatchFuture(m_jobFuture).accept(serverEvent));
  }
