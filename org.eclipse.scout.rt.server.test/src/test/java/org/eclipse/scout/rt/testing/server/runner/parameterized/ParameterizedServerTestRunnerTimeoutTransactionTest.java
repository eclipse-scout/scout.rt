...
public class ParameterizedServerTestRunnerTimeoutTransactionTest {
  ...
  private Map<String, Set<ITransaction>> m_protocolByTestMethod;
  ...
  protected void updateProtocol() {
    ...
    Set<ITransaction> p = m_protocolByTestMethod.computeIfAbsent(testName, k -> new HashSet<>(3));
  ...
  protected void verifyProtocol() {
    ...
    Set<ITransaction> transactions = m_protocolByTestMethod.get(testName);
