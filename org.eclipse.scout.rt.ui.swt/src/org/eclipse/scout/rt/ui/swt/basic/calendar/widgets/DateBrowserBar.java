...
public class DateBrowserBar extends Composite {
  ...
  /** contained widgets */
  protected Button m_fastbackward;
  protected Button m_backward;
  protected Label m_label;
  protected Button m_forward;
  protected Button m_fastforward;
  ...
  protected void createControls () {
    ...
    m_fastbackward.setBackground(SwtColors.getInstance().white);
    gd = new GridData();
    ...
    m_backward.setText("\u2039" /*"‹"*/);
    m_backward.setBackground(SwtColors.getInstance().white);
    gd = new GridData();
    gd.horizontalAlignment = GridData.BEGINNING;
    gd.heightHint = 20;
    gd.widthHint = 20;
    ...
    m_label.setBackground(SwtColors.getInstance().white);
    gd = new GridData();
    ...
    m_forward.setText("\u203A" /*"›"*/);
    m_forward.setBackground(SwtColors.getInstance().white);
    gd = new GridData();
    ...
    m_fastforward.setBackground(SwtColors.getInstance().white);
    gd = new GridData();
    gd.horizontalAlignment = GridData.END;
    gd.heightHint = 20;
    gd.widthHint = 20;
